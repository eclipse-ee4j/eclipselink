...
public class BuildROWTYPETestSuite extends BuilderTestSuite {
    ...
    public void Tesmanproc17() {
        ...
        DatabaseType[] typesForMethod = helperObjectsBuilder.getTypesForMethod(PROCF17_NAME.toUpperCase());
        ...
        assertTrue("wrong databaseType for ttField",
            ttField.isComplexDatabaseType() && ((ComplexDatabaseType)secondFieldType).isJDBCType());
