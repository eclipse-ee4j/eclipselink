...
import static dbws.testing.DBWSTestSuite.SOAP12;
import static dbws.testing.DBWSTestSuite.SOAP12_NAMESPACE;
import static dbws.testing.DBWSTestSuite.SOAP12_PORT;
import static dbws.testing.DBWSTestSuite.SOAP12_SERVICE;
import static dbws.testing.DBWSTestSuite.SOAP12_SERVICE_NAMESPACE;
import static dbws.testing.DBWSTestSuite.SOAP12_TEST;
import static dbws.testing.DBWSTestSuite.buildConnection;
import static dbws.testing.DBWSTestSuite.runDdl;

@WebServiceProvider(
    targetNamespace = SOAP12_SERVICE_NAMESPACE,
    serviceName = SOAP12_SERVICE,
    portName = SOAP12_PORT
)
@ServiceMode(MESSAGE)
...
public class SOAP12TestSuite extends ProviderHelper implements Provider<SOAPMessage> {
    ...
    public static final String ENDPOINT_ADDRESS = "http://localhost:9999/" + SOAP12;
    ...
    public static void teardown() {
        ...
        if (ddlDrop) {
            runDdl(conn, DROP_SOAP12_TABLE, ddlDebug);
        }
    }
