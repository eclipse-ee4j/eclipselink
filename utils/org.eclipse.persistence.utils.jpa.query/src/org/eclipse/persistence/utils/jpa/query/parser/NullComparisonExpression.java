...
/**
 * A null comparison tests whether or not the single-valued path expression or
 * input parameter is a <b>NULL</b> value.
 * <p>
...
public final class NullComparisonExpression extends AbstractExpression
{
	 ...
	 *
	 * @return <code>true</code> the expression preceding the identifier was
	 ...
	 *
	 * @return <code>true</code> if <b>NOT</b> is present in the query;
	...
	/**
	 * This enumeration lists all the possible choices when using a null
