...
/**
 * This {@link CollectionMemberDeclarationFactory} creates a new
 * {@link CollectionMemberDeclaration} when the portion of the query to parse
 * starts with <b>IN</b>.
 *
...
final class CollectionMemberDeclarationFactory extends ExpressionFactory
{
	/**
