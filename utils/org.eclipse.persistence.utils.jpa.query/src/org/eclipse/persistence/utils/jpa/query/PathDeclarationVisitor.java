...
/**
 * This visitor is used to retrieve the collection-valued path name from a
 * {@link CollectionMemberDeclaration} or from a {@link Join} but also for
 * an identification variable or a state field path expression.
 *
 * @version 11.2.0
 * @since 11.2.0
...
{
	/**
	 * The parent resolver used to parent the resolver that will be created by
	 * this visitor.
	 */
	 ...
	 *
	 * @param parent The parent resolver used to parent the resolver that will be created by this
	 * visitor
	 */
	...
	{
		resolver = new IdentificationVariableResolver(parent, expression.toParsedText());
	}
