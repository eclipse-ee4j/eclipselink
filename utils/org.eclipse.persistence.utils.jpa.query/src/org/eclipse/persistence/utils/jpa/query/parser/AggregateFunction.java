...
/**
 * In the <b>SELECT</b> clause the result of a query may be the result of an
 * aggregate function applied to a path expression. The following aggregate
 * functions can be used in the <b>SELECT</b> clause of a query: <b>AVG</b>,
 * <b>COUNT</b>, <b>MAX</b>, <b>MIN</b>, <b>SUM</b>.
 * <p>
 * A <code>single_valued_association_field</code> is designated by the name of
 * an association-field in a one-to-one or many-to-one relationship. The type of
 * a <code>single_valued_association_field</code> and thus a
 * <code>single_valued_association_path_expression</code> is the abstract schema
 * type of the related entity.
 * <p>
 * The argument to an aggregate function may be preceded by the keyword
 * <b>DISTINCT</b> to specify that duplicate values are to be eliminated before
 * the aggregate function is applied. Null values are eliminated before the
 * aggregate function is applied, regardless of whether the keyword <b>DISTINCT</b>
 * is specified.
 *
 * <div nowrap><b>BNF:</b> <code>expression ::= {AVG|MAX|MIN|SUM}([DISTINCT] state_field_path_expression)</code><p>
 *
 * @see AvgFunction
 * @see CountFunction
 * @see MaxFunction
...
public abstract class AggregateFunction extends AbstractSingleEncapsulatedExpression
{
	...
	/**
	 * Determines whether the <b>DISTINCT</b> identifier was specified in the
	 * query.
	 *
	 * @return <code>true</code> if the query has <b>DISTINCT</b>;
