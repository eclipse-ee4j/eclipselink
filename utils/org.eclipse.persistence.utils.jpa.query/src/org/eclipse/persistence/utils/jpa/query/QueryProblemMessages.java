...
/**
 * The list of messages used by {@link QueryProblem QueryProblems} when
 * validating a Java Persistence query.
 *
 * @version 11.2.0
 * @since 11.2.0
...
public interface QueryProblemMessages
{
	...
	String CollectionMemberDeclaration_InvalidCollectionExpression = "COLLECTION_MEMBER_DECLARATION_INVALID_COLLECTION_EXPRESSION";
	...
	String CollectionMemberExpression_InvalidCollectionExpression = "COLLECTION_MEMBER_EXPRESSION_INVALID_COLLECTION_EXPRESSION";
	...
	String ConcatExpression_FirstExpression_WrongType = "CONCAT_EXPRESSION_FIRST_EXPRESSION_WRONG_TYPE";
	String ConcatExpression_InvalidFirstExpression = "CONCAT_EXPRESSION_INVALID_FIRST_EXPRESSION";
	String ConcatExpression_InvalidSecondExpression = "CONCAT_EXPRESSION_INVALID_SECOND_EXPRESSION";
	String ConcatExpression_MissingComma = "CONCAT_EXPRESSION_MISSING_COMMA";
	String ConcatExpression_MissingFirstExpression = "CONCAT_EXPRESSION_MISSING_FIRST_EXPRESSION";
	...
	String ConcatExpression_MissingSecondExpression = "CONCAT_EXPRESSION_MISSING_SECOND_EXPRESSION";
	String ConcatExpression_SecondExpression_WrongType = "CONCAT_EXPRESSION_SECOND_EXPRESSION_WRONG_TYPE";
	...
	String EmptyCollectionComparisonExpression_InvalidCollectionExpression = "EMPTY_COLLECTION_COMPARISON_EXPRESSION_INVALID_COLLECTION_EXPRESSION";
	...
	String FuncExpression_MissingExpression = "FUNC_EXPRESSION_MISSING_EXPRESSION";
	...
	String HavingClause_ConditionalExpressionMissing = "HAVING_CLAUSE_CONDITIONAL_MISSING_EXPRESSION";
	...
	String InExpression_InItem_WrongType = "IN_EXPRESSION_IN_ITEM_WRONG_TYPE";
	...
	String InExpression_MalformedStateFieldPathExpression = "IN_EXPRESSION_MALFORMED_STATE_FIELD_PATH_EXPRESSION";
	...
	String InExpression_MissingStateFieldPathExpression = "IN_EXPRESSION_MISSING_STATE_FIELD_PATH_EXPRESSION";
	String InExpression_WrongType = "IN_EXPRESSION_WRONG_TYPE";
	...
	String InputParameter_ReservedWord = "INPUT_PARAMETER_RESERVED_WORD";
	...
	String SizeExpression_InvalidCollectionExpression = "SIZE_EXPRESSION_INVALID_COLLECTION_EXPRESSION";
	...
	//	String UpdateItem_InvalidNewValue = "UPDATE_ITEM_INVALID_NEW_VALUE";
	String UpdateItem_InvalidStateFieldPathExpression = "UPDATE_ITEM_INVALID_STATE_FIELD_PATH_EXPRESSION";
	...
	String WhereClause_ConditionalExpressionMissing = "WHERE_CLAUSE_CONDITIONAL_MISSING_EXPRESSION";
}