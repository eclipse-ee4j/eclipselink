...
/**
 * A <code>collection_valued_field</code> is designated by the name of an
 * association field in a one-to-many or a many-to-many relationship or by the
 * name of an element collection field. The type of a <code>collection_valued_field</code>
