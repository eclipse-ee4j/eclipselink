...
public final class QueryProblemsResourceBundle extends ListResourceBundle
{
	/**
	 * {@inheritDoc}
	 */
	...
	protected Object[][] getContents()
	{
		Object[][] contents =
		{
			...
			// ArithmeticFactor
			{"ARITHMETIC_FACTOR_MISSING_EXPRESSION", "An arthmetic factor must be followed by an expression."},
			...
			{"COLLECTION_MEMBER_EXPRESSION_INVALID_COLLECTION_EXPRESSION",             "''{0}'' does not resolve to an association field or an element collection field."},
			...
			// CollectionMemberDeclaration - Semantic
			{"COLLECTION_MEMBER_DECLARATION_INVALID_COLLECTION_EXPRESSION",             "''{0}'' does not resolve to an association field or an element collection field."},
			...
			{"CONCAT_EXPRESSION_INVALID_FIRST_EXPRESSION",     "The first expression is not valid expression."},
			{"CONCAT_EXPRESSION_INVALID_SECOND_EXPRESSION",    "The second expression is not valid expression."},
			{"CONCAT_EXPRESSION_MISSING_COMMA",                "The comma is missing after the first expression."},
			{"CONCAT_EXPRESSION_MISSING_FIRST_EXPRESSION",     "The first expression is missing from the CONCAT expression."},
			...
			{"CONCAT_EXPRESSION_MISSING_SECOND_EXPRESSION",    "The second expression is missing from the CONCAT expression."},
			// ConcatExpression - Semantic
			{"CONCAT_EXPRESSION_FIRST_EXPRESSION_WRONG_TYPE",  "The first expression is not a String."},
			{"CONCAT_EXPRESSION_SECOND_EXPRESSION_WRONG_TYPE", "The second expression is not a String."},
			...
			// EmptyCollectionComparisonExpression - Semantic
			{"EMPTY_COLLECTION_COMPARISON_EXPRESSION_INVALID_COLLECTION_EXPRESSION", "''{0}'' cannot be resolved to a collection type."},
			...
			// FuncExpression
			{"FUNC_EXPRESSION_MISSING_EXPRESSION",        "At least one item must be provided for a FUNC expression."},
			...
			// HavingClause
			{"HAVING_CLAUSE_CONDITIONAL_MISSING_EXPRESSION", "The conditional expression is missing from the HAVING clause."},
			...
			{"IN_EXPRESSION_MALFORMED_STATE_FIELD_PATH_EXPRESSION", "The IN expression does not have a valid state field path expression."},
			...
			{"IN_EXPRESSION_MISSING_STATE_FIELD_PATH_EXPRESSION",   "A state field path expression must be defined."},
			// InExpression - Semantic
			{"IN_EXPRESSION_IN_ITEM_WRONG_TYPE",                    "The encapsulated items must be of the same type."},
			{"IN_EXPRESSION_WRONG_TYPE",                            "The type of the state field path expression and the items do not match."},
			...
			{"INPUT_PARAMETER_RESERVED_WORD",             "The named input parameter ''{0}'' cannot be a reserved word."},
			...
			// SizeExpression - Semantic
			{"SIZE_EXPRESSION_INVALID_COLLECTION_EXPRESSION", "''{0}'' cannot be resolved to a collection type."},
			...
			// UpdateItem
//			{"UPDATE_ITEM_INVALID_NEW_VALUE",                   "The right expression of the assignment is not a valid new value."},
			{"UPDATE_ITEM_INVALID_STATE_FIELD_PATH_EXPRESSION", "The state field cannot be an identification variable."},
			...
			// WhereClause
			{"WHERE_CLAUSE_CONDITIONAL_MISSING_EXPRESSION", "The conditional expression is missing from the WHERE clause."},
		};
