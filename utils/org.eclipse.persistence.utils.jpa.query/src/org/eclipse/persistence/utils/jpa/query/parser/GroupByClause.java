...
/**
 * The <b>GROUP BY</b> construct enables the aggregation of values according to
...
public final class GroupByClause extends AbstractExpression
{
	...
	/**
	 * Returns the {@link Expression} that represents the list of group by items
	 * if any was parsed.
	 *
	 ...
	 *
	 * @return <code>true</code> if there was a whitespace after <b>GROUP BY</b>;
