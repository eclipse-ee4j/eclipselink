...
/**
 * The <code>new_value</code specified for an update operation must be
 * compatible in type with the field to which it is assigned.
 *
...
public final class UpdateItem extends AbstractExpression
{
	...
	/**
	 * Returns the {@link Expression} representing the new value, which is the
	...
	/**
	 * Returns the {@link Expression} representing the state field path expression,
	 * which is the property that should get updated.
	 *
	 ...
	 * Determines whether the equal sign was parsed or not.
	 *
	 * @return <code>true</code> if the equal sign was parsed; <code>false</code>
	 * otherwise
	 */
	 ...
	 *
	 * @return <code>true</code> the new value was parsed; <code>false</code>
	 ...
	 * Determines whether a whitespace was parsed after the equal sign or not.
	 *
	 * @return <code>true</code> if there was a whitespace after the equal sign;
	 ...
	 *
	 * @return <code>true</code> the state field was parsed; <code>false</code>
	 * otherwise
	 */
