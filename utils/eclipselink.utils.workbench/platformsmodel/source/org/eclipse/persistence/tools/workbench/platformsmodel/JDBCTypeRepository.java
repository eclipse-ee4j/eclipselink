...
//      this.addJDBCToJavaMapping(Types.REF_CURSOR,     java.sql.Ref.class); // JDK 8
        this.addJDBCToJavaMapping(2012,                 java.sql.Ref.class); // REF_CURSOR = 2012, to compile on JDK 7
...
//        this.addJDBCToJavaMapping(Types.TIME_WITH_TIMEZONE, java.sql.Time.class); // JDK 8
        this.addJDBCToJavaMapping(2013,                 java.sql.Time.class); // TIME_WITH_TIMEZONE = 2013, to compile on JDK 7
...
//        this.addJDBCToJavaMapping(Types.TIMESTAMP_WITH_TIMEZONE, java.sql.Timestamp.class); // JDK 8
        this.addJDBCToJavaMapping(2014,                 java.sql.Timestamp.class); // TIMESTAMP_WITH_TIMEZONE = 2014, to compile on JDK 7
