...
// ********** AfterLoadingPolicy API**********
	...
	public static ClassDescriptor legacy50BuildDescriptor() {
		...
		SDKAggregateCollectionMapping mappingsMapping = new SDKAggregateCollectionMapping();
		mappingsMapping.setAttributeName("mappings");
		mappingsMapping.setReferenceClass(MWMapping.class);
		mappingsMapping.setFieldName("mappings");
		descriptor.addMapping(mappingsMapping);
		...
		copyPolicyMapping.setGetMethodName("getCopyPolicyForTopLink");
		copyPolicyMapping.setReferenceClass(MWDescriptorCopyPolicy.class);
		copyPolicyMapping.setFieldName("mapping-descriptor-copy-policy");
		descriptor.addMapping(copyPolicyMapping);

		SDKAggregateObjectMapping eventsPolicyMapping = new SDKAggregateObjectMapping();
		eventsPolicyMapping.setAttributeName("eventsPolicy");
		eventsPolicyMapping.setReferenceClass(MWDescriptorEventsPolicy.class);
		eventsPolicyMapping.setSetMethodName("setEventsPolicyForTopLink");
		eventsPolicyMapping.setGetMethodName("getEventsPolicyForTopLink");
		eventsPolicyMapping.setFieldName("events-policy");
		descriptor.addMapping(eventsPolicyMapping);

		SDKAggregateObjectMapping afterLoadingPolicyMapping = new SDKAggregateObjectMapping();
		afterLoadingPolicyMapping.setAttributeName("afterLoadingPolicy");
		afterLoadingPolicyMapping.setSetMethodName("setAfterLoadingPolicyForTopLink");
		afterLoadingPolicyMapping.setGetMethodName("getAfterLoadingPolicyForTopLink");
		afterLoadingPolicyMapping.setReferenceClass(MWDescriptorAfterLoadingPolicy.class);
		afterLoadingPolicyMapping.setFieldName("after-loading-policy");
		descriptor.addMapping(afterLoadingPolicyMapping);
		...
		instantiationPolicyMapping.setGetMethodName("getInstantiationPolicyForTopLink");
		instantiationPolicyMapping.setSetMethodName("setInstantiationPolicyForTopLink");
		instantiationPolicyMapping.setFieldName("mapping-descriptor-instantiation-policy");
		descriptor.addMapping(instantiationPolicyMapping);
	...
	public void legacy50PostPostProjectBuild() {
		...
		legacyRemoveUnmappedMappings();
	}

	private void legacyRemoveUnmappedMappings() {
		for (Iterator mappings = mappings();mappings.hasNext(); ) {
			MWMapping mapping = (MWMapping) mappings.next();
			if (mapping.isInherited()) {
				addInheritedAttribute(mapping.getInstanceVariable());
			}
			if (mapping instanceof MWLegacyUnmappedMapping) {
	...
	public static ClassDescriptor legacy45BuildDescriptor() {
		...
		copyPolicyMapping.setGetMethodName("getCopyPolicyForTopLink");
		copyPolicyMapping.setReferenceClass(MWDescriptorCopyPolicy.class);
		copyPolicyMapping.setFieldName("copyPolicy");
		descriptor.addMapping(copyPolicyMapping);
		...
		eventsPolicyMapping.setSetMethodName("setEventsPolicyForTopLink");
		eventsPolicyMapping.setGetMethodName("getEventsPolicyForTopLink");
		eventsPolicyMapping.setFieldName("eventsPolicy");
		descriptor.addMapping(eventsPolicyMapping);
		...
		afterLoadingPolicyMapping.setSetMethodName("setAfterLoadingPolicyForTopLink");
		afterLoadingPolicyMapping.setGetMethodName("getAfterLoadingPolicyForTopLink");
		afterLoadingPolicyMapping.setFieldName("afterLoadingPolicy");
		descriptor.addMapping(afterLoadingPolicyMapping);
		...
		instantiationPolicyMapping.setGetMethodName("getInstantiationPolicyForTopLink");
		instantiationPolicyMapping.setSetMethodName("setInstantiationPolicyForTopLink");
		instantiationPolicyMapping.setFieldName("instantiationPolicy");
		descriptor.addMapping(instantiationPolicyMapping);
