	...
	implements MWDataField
{
	...
	public static ClassDescriptor legacy50BuildDescriptor() {
		...
		descriptor.setJavaClass(MWColumn.class);
		descriptor.setTableName("database-field");

		descriptor.addDirectMapping("name", "name");
		descriptor.addDirectMapping("databaseTypeName", "legacyGetDatabaseTypeNameForTopLink", "legacySetDatabaseTypeNameForTopLink", "type");

		((DirectToFieldMapping) descriptor.addDirectMapping("size", "size")).setNullValue(new Integer(0));
		((DirectToFieldMapping) descriptor.addDirectMapping("subSize", "sub-size")).setNullValue(new Integer(0));

		((DirectToFieldMapping) descriptor.addDirectMapping("allowsNull", "allows-null")).setNullValue(Boolean.FALSE);
		((DirectToFieldMapping) descriptor.addDirectMapping("unique", "unique")).setNullValue(Boolean.FALSE);
		((DirectToFieldMapping) descriptor.addDirectMapping("primaryKey", "primary-key")).setNullValue(Boolean.FALSE);
		((DirectToFieldMapping) descriptor.addDirectMapping("identity", "identity")).setNullValue(Boolean.FALSE);

		return descriptor;
	}

	private String legacyGetDatabaseTypeNameForTopLink() {
		throw new UnsupportedOperationException();
	}
	private void legacySetDatabaseTypeNameForTopLink(String databaseTypeName) {
		this.databaseTypeHandle.legacySetDatabaseTypeNameForTopLink(databaseTypeName);
	}
	...
	public static ClassDescriptor legacy45BuildDescriptor() {
		...
		descriptor.setJavaClass(MWColumn.class);
		descriptor.setTableName("DatabaseField");
	
		descriptor.addDirectMapping("name", "name");
		descriptor.addDirectMapping("databaseTypeName", "legacyGetDatabaseTypeNameForTopLink", "legacySetDatabaseTypeNameForTopLink", "type");

		((DirectToFieldMapping) descriptor.addDirectMapping("size", "size")).setNullValue(new Integer(0));
		((DirectToFieldMapping) descriptor.addDirectMapping("subSize", "subSize")).setNullValue(new Integer(0));

		((DirectToFieldMapping) descriptor.addDirectMapping("allowsNull", "allowsNull")).setNullValue(Boolean.FALSE);
		((DirectToFieldMapping) descriptor.addDirectMapping("unique", "unique")).setNullValue(Boolean.FALSE);
		((DirectToFieldMapping) descriptor.addDirectMapping("primaryKey", "primaryKey")).setNullValue(Boolean.FALSE);
		((DirectToFieldMapping) descriptor.addDirectMapping("identity", "identity")).setNullValue(Boolean.FALSE);
