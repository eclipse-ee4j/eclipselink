...
{	
    private MWEisPrimaryKeyPolicy primaryKeyPolicy;
	...
	public static XMLDescriptor buildDescriptor() {
        ...
        primaryKeyFieldPolicyMapping.setReferenceClass(MWEisPrimaryKeyPolicy.class);
    ...
    protected void initialize(Node parent) {
        ...
        this.primaryKeyPolicy = new MWEisPrimaryKeyPolicy(this);
    }
    ...
    public MWEisPrimaryKeyPolicy getPrimaryKeyPolicy() {
