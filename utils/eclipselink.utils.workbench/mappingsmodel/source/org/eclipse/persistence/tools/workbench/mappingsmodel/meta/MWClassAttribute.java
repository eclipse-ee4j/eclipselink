...
public final class MWClassAttribute extends MWModel 
	...
	public static ClassDescriptor legacy50BuildDescriptor() {
		...
		descriptor.setJavaClass(MWClassAttribute.class);
		descriptor.setTableName("class-attribute");
		...
		SDKAggregateObjectMapping typeDeclarationMapping = new SDKAggregateObjectMapping();
		typeDeclarationMapping.setAttributeName("typeDeclaration");
		typeDeclarationMapping.setReferenceClass(MWTypeDeclaration.class);
		typeDeclarationMapping.setFieldName("attribute-type-declaration");
		descriptor.addMapping(typeDeclarationMapping);
		
		OneToOneMapping valueTypeMapping = new OneToOneMapping();
		valueTypeMapping.setAttributeName("valueType");
		valueTypeMapping.setGetMethodName("legacy50GetValueTypeForTopLink");
		valueTypeMapping.setSetMethodName("legacy50SetValueTypeForTopLink");
		valueTypeMapping.setReferenceClass(MWClass.class);
		valueTypeMapping.setForeignKeyFieldName("value-type");
		valueTypeMapping.dontUseIndirection();
		descriptor.addMapping(valueTypeMapping);
		
		OneToOneMapping itemTypeMapping = new OneToOneMapping();
		itemTypeMapping.setAttributeName("itemType");
		itemTypeMapping.setGetMethodName("legacy50GetItemTypeForTopLink");
		itemTypeMapping.setSetMethodName("legacy50SetItemTypeForTopLink");
		itemTypeMapping.setReferenceClass(MWClass.class);
		itemTypeMapping.setForeignKeyFieldName("item-type");
		itemTypeMapping.dontUseIndirection();
		descriptor.addMapping(itemTypeMapping);
		
		OneToOneMapping keyTypeMapping = new OneToOneMapping();
		keyTypeMapping.setAttributeName("keyType");
		keyTypeMapping.setGetMethodName("legacy50GetKeyTypeForTopLink");
		keyTypeMapping.setSetMethodName("legacy50SetKeyTypeForTopLink");
		keyTypeMapping.setReferenceClass(MWClass.class);
		keyTypeMapping.setForeignKeyFieldName("key-type");
		keyTypeMapping.dontUseIndirection();
		...
		getMethodHandleMapping.setSetMethodName("setGetMethodHandleForTopLink");
		getMethodHandleMapping.setReferenceClass(MWMethodHandle.class);
		getMethodHandleMapping.setFieldName("get-method");
		descriptor.addMapping(getMethodHandleMapping);
		...
		setMethodHandleMapping.setSetMethodName("setSetMethodHandleForTopLink");
		setMethodHandleMapping.setReferenceClass(MWMethodHandle.class);
		setMethodHandleMapping.setFieldName("set-method");
		descriptor.addMapping(setMethodHandleMapping);
		
		SDKAggregateObjectMapping valueGetMethodHandleMapping = new SDKAggregateObjectMapping();
		valueGetMethodHandleMapping.setAttributeName("valueGetMethodHandle");
		valueGetMethodHandleMapping.setGetMethodName("getValueGetMethodHandleForTopLink");
		valueGetMethodHandleMapping.setSetMethodName("setValueGetMethodHandleForTopLink");
		valueGetMethodHandleMapping.setReferenceClass(MWMethodHandle.class);
		valueGetMethodHandleMapping.setFieldName("value-get-method");
		descriptor.addMapping(valueGetMethodHandleMapping);
		
		SDKAggregateObjectMapping valueSetMethodHandleMapping = new SDKAggregateObjectMapping();
		valueSetMethodHandleMapping.setAttributeName("valueSetMethodHandle");
		valueSetMethodHandleMapping.setGetMethodName("getValueSetMethodHandleForTopLink");
		valueSetMethodHandleMapping.setSetMethodName("setValueSetMethodHandleForTopLink");
		valueSetMethodHandleMapping.setReferenceClass(MWMethodHandle.class);
		valueSetMethodHandleMapping.setFieldName("value-set-method");
		descriptor.addMapping(valueSetMethodHandleMapping);
		
		SDKAggregateObjectMapping addMethodHandleMapping = new SDKAggregateObjectMapping();
		addMethodHandleMapping.setAttributeName("addMethodHandle");
		addMethodHandleMapping.setGetMethodName("getAddMethodHandleForTopLink");
		addMethodHandleMapping.setSetMethodName("setAddMethodHandleForTopLink");
		addMethodHandleMapping.setReferenceClass(MWMethodHandle.class);
		addMethodHandleMapping.setFieldName("add-method");
		descriptor.addMapping(addMethodHandleMapping);
		
		SDKAggregateObjectMapping removeMethodHandleMapping = new SDKAggregateObjectMapping();
		removeMethodHandleMapping.setAttributeName("removeMethodHandle");
		removeMethodHandleMapping.setGetMethodName("getRemoveMethodHandleForTopLink");
		removeMethodHandleMapping.setSetMethodName("setRemoveMethodHandleForTopLink");
		removeMethodHandleMapping.setReferenceClass(MWMethodHandle.class);
		removeMethodHandleMapping.setFieldName("remove-method");
		descriptor.addMapping(removeMethodHandleMapping);
		
		return descriptor;
	}
	
	private void legacy50SetValueTypeForTopLink(MWClass valueType) {
		this.valueTypeHandle = new MWClassHandle(this, valueType, this.buildValueTypeScrubber());
	}
	/**
	 * this method is needed because writes happen during the read in the class override trickery
	 */
	private MWClass legacy50GetValueTypeForTopLink() {
		return this.getValueType();
	}

	private void legacy50SetItemTypeForTopLink(MWClass itemType) {
		this.itemTypeHandle = new MWClassHandle(this, itemType, this.buildItemTypeScrubber());
	}
	/**
	 * this method is needed because writes happen during the read in the class override trickery
	 */
	private MWClass legacy50GetItemTypeForTopLink() {
		return this.getItemType();
	}

	private void legacy50SetKeyTypeForTopLink(MWClass keyType) {
		this.keyTypeHandle = new MWClassHandle(this, keyType, this.buildKeyTypeScrubber());
	}
	/**
	 * this method is needed because writes happen during the read in the class override trickery
	 */
	private MWClass legacy50GetKeyTypeForTopLink() {
	...
	public static ClassDescriptor legacy45BuildDescriptor() {
		...
		descriptor.setJavaClass(MWClassAttribute.class);
		descriptor.setTableName("ClassAttribute");
		...
		SDKAggregateObjectMapping tyepDeclarationMapping = new SDKAggregateObjectMapping();
		tyepDeclarationMapping.setAttributeName("typeDeclaration");
		tyepDeclarationMapping.setReferenceClass(MWTypeDeclaration.class);
		tyepDeclarationMapping.setFieldName("attributeType");
		descriptor.addMapping(tyepDeclarationMapping);
		
		OneToOneMapping itemTypeMapping = new OneToOneMapping();
		itemTypeMapping.setAttributeName("itemType");
		itemTypeMapping.setGetMethodName("legacy45GetItemTypeForTopLink");
		itemTypeMapping.setSetMethodName("legacy45SetItemTypeForTopLink");
		itemTypeMapping.setReferenceClass(MWClass.class);
		itemTypeMapping.setForeignKeyFieldName("itemType");
		itemTypeMapping.dontUseIndirection();
		descriptor.addMapping(itemTypeMapping);
	...
	private void legacy45SetItemTypeForTopLink(MWClass itemType) {
		this.itemTypeHandle = new MWClassHandle(this, itemType, this.buildItemTypeScrubber());
	}
	private MWClass legacy45GetItemTypeForTopLink() {
		throw new UnsupportedOperationException();
	}
	
	protected void legacy45PostBuild(DescriptorEvent event) {
		this.legacy45InitializeHandles();
	...
	public void legacy45PostPostProjectBuild() {
		...
		this.updateNestedTypes();
		this.legacy45AdjustValueTypeAndItemTypeFromOldItemType();
		this.legacy45AdjustGetAndSetMethodsForEjb20Attribute();
	}
	
	private void legacy45InitializeHandles() {
		this.getMethodHandle = new MWMethodHandle(this, this.buildGetMethodScrubber());
		this.setMethodHandle = new MWMethodHandle(this, this.buildSetMethodScrubber());
		this.valueGetMethodHandle = new MWMethodHandle(this, this.buildValueGetMethodScrubber());
		this.valueSetMethodHandle = new MWMethodHandle(this, this.buildValueSetMethodScrubber());
	...
	/**
	 * In 4.5 projects and older, we used item type to indicate the type contained
	 * 	by *either* a value holder or a collection attribute type.
	 * We need to determine which of these the old item type actually specifies and put it in the right place.
	 * 
	 * If the attribute type is a value holder, the old item type becomes the new value type.
	 * If the attribute type is a map or collection, the old item type remains as the new item type.
	 * If the attribute type is neither, the old item type is tossed out (no longer allowed).
	 */
	private void legacy45AdjustValueTypeAndItemTypeFromOldItemType() {
		if (this.itemTypeHandle.getType() == null) {
			return;
		}
		if (this.getType().isValueHolder()) {
			this.valueTypeHandle.setType(this.itemTypeHandle.getType());
			this.itemTypeHandle.setType(null);
		}
	...
	/**
	 * In 4.5 projects and older, EJB attributes (or any attribute for that matter) did not 
	 * 	have associated get and set methods.  In 9.0.5 and beyond, EJB attributes must have
	 * 	get and set methods, as they can not be defined without them.
	 */
	private void legacy45AdjustGetAndSetMethodsForEjb20Attribute() {
		if (this.isEjb20Attribute()) {
			this.generateGetAndSetMethods();
		}
	}
