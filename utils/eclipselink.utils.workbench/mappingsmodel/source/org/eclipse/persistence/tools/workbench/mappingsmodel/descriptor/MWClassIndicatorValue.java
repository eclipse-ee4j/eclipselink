...
public final class MWClassIndicatorValue extends MWModel {
	...
	public static ClassDescriptor legacy50BuildDescriptor() {
		...
		descriptor.setJavaClass(MWClassIndicatorValue.class);
		descriptor.setTableName("class-indicator-value");

		descriptor.addDirectMapping("indicatorValue", "indicator");

		OneToOneMapping descriptorValueMapping = new OneToOneMapping();
		descriptorValueMapping.setAttributeName("descriptorValue");
		descriptorValueMapping.setGetMethodName("legacyGetDescriptorValue");
		descriptorValueMapping.setSetMethodName("legacySetDescriptorValue");
		descriptorValueMapping.setReferenceClass(MWDescriptor.class);
		descriptorValueMapping.setForeignKeyFieldName("class-indicator-value-descriptor");
		descriptorValueMapping.dontUseIndirection();
		descriptor.addMapping(descriptorValueMapping);

		return descriptor;
	}

	private void legacySetDescriptorValue(MWDescriptor descriptor){
		this.descriptorValueHandle = new MWDescriptorHandle(this, descriptor, this.buildDescriptorValueScrubber());
	}
	private MWDescriptor legacyGetDescriptorValue() {
	...
	public static ClassDescriptor legacy45BuildDescriptor() {
		...
		descriptor.setJavaClass(MWClassIndicatorValue.class);
		descriptor.setTableName("ClassIndicatorValue");
		descriptor.descriptorIsAggregate();
		...
		descriptorValueMapping.setSetMethodName("legacySetDescriptorValue");
		descriptorValueMapping.setReferenceClass(MWDescriptor.class);
		descriptorValueMapping.setForeignKeyFieldName("descriptor");
		descriptorValueMapping.dontUseIndirection();
		descriptor.addMapping(descriptorValueMapping);
