...
public final class ElementTypeableXmlFieldPanel 
	extends AbstractAggregatableXmlFieldPanel
{
	// **************** Construction ******************************************
	
	ElementTypeableXmlFieldPanel(ValueModel mappingHolder, ValueModel xmlFieldHolder, WorkbenchContextHolder contextHolder, String mappingPropertyString) {
