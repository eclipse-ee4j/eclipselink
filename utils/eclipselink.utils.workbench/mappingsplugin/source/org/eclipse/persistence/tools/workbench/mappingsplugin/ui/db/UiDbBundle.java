...
public class UiDbBundle extends java.util.ListResourceBundle
{
	...
	static final Object[][] contents = {
		...
		{"CLEAR_LOGIN.message",  "Changing the database platform changes the database tables in the project to the match the new platform.{0}It is strongly recomended to clear the development login.  Clear development login?"},
		{"CLEAR_LOGIN_AND_LOGOUT.title",	"Logout and Clear Development Login"},
		{"CLEAR_LOGIN_AND_LOGOUT.message",  "Changing the database platform changes the database tables in the project to the match the new platform.{0}It is strongly recomended to log out (if logged in) and clear the development login.{0}Log off and clear development login?"},
