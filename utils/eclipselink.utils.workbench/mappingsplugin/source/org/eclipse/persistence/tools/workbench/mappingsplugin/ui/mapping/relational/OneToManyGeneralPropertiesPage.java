...
final class OneToManyGeneralPropertiesPage extends ScrollablePropertiesPage
{
	OneToManyGeneralPropertiesPage(PropertyValueModel nodeHolder, WorkbenchContextHolder contextHolder)
	{
	...
	protected Component buildPage() {
		...
		addHelpTopicId(useBatchReadingCheckBox, "mapping.useBatchWriting");
		...
		addHelpTopicId(container, "mapping.oneToMany");
		return container;
	}
