...
public class UiProjectBundle extends ListResourceBundle {
	...
	static final Object[][] contents = {
		...
		{"SAVE_AS_DIALOG_MWP_FILE_FILTER", "TopLink Workbench Project (*.mwp)"},
			...
			{"PROJECT_CURRENTLY_LOADED_DIALOG.message" ,"A project named \"{0}\" is currently loaded in the TopLink Workbench. Please close this project before deletion."},
		...
		{"NO_PERSISTENCE_TYPE_SPECIFIED_ERROR",           "TopLink Workbench could not determine a project persistence type from the xml file."},
		{"NO_SINGLE_PERSISTENCE_TYPE_ERROR",              "TopLink Workbench requires that all entities in the xml file for this project have the same persistence-type and/or cmp-version. The project will be set according to the persistence-type and/or cmp-version of the first entity in the file."},
		...
		{"NOT_SINGLE_PERSISTENCE_TYPE_WARNING",                   "TopLink Workbench requires that all entities in the xml file for this project have the same persistence-type and/or cmp-version. The project will be set according to the persistence-type and/or cmp-version of the first entity in the file."},
