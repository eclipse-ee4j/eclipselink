...
public final class EisDirectCollectionMappingNode 
	extends MappingNode
{
	// **************** Constructors ******************************************
	
	public EisDirectCollectionMappingNode(MWXmlDirectCollectionMapping mapping, SelectionActionsPolicy mappingNodeTypePolicy, XmlDescriptorNode parent) {
...
//		return getDescriptorNode().mappingHelpTopicPrefix() + ".directCollection";
	...
	protected Class propertiesPageClass() {
		return EisDirectCollectionMappingPropertiesPage.class;
	}
