...
final class EisDirectCollectionMappingGeneralPropertiesPage
	extends ScrollablePropertiesPage
{
	// **************** Constructors ******************************************
	
	EisDirectCollectionMappingGeneralPropertiesPage(PropertyValueModel xmlDirectCollectionMappingNodeHolder, WorkbenchContextHolder contextHolder) {
