...
public final class SemanticValidatorTest extends AbstractValidatorTest {
...
//			return new SemanticValidator(query);
			Class<?> validatorClass = Class.forName("org.eclipse.persistence.utils.jpa.query.SemanticValidator");
...
//		testHasProblem(
//			problems,
//			QueryProblemMessages.AbstractSchemaName_NotResolvable,
//			startPosition,
//			endPosition
//		);
	}
	...
	@Test
	public void test_ConstructorExpression_MismatchedParameterTypes_1() throws Exception {

		String query = "SELECT NEW jpql.query.Employee(e.name) FROM Employee e";
		int startPosition = "SELECT NEW jpql.query.Employee(".length();
		int endPosition   = "SELECT NEW jpql.query.Employee(e.name".length();

		List<JPQLQueryProblem> problems = validate(query);

		testHasProblem(
			problems,
			JPQLQueryProblemMessages.ConstructorExpression_MismatchedParameterTypes,
			startPosition,
			endPosition
		);
	}
	...
	@Test
	public void test_ConstructorExpression_MismatchedParameterTypes_2() throws Exception {

		String query = "SELECT NEW jpql.query.Employee(e.empId) FROM Employee e";
		List<JPQLQueryProblem> problems = validate(query);
	...
	public void test_EncapsulatedIdentificationVariableExpression_NotMapValued_1() throws Exception {
		...
		String query = "SELECT ENTRY(cust) FROM CodeAssist c JOIN c.customerMap cust";
		List<JPQLQueryProblem> problems = validate(query);
...
//		);
	...
	public void test_NullComparisonExpression_InvalidCollectionExpression_1() throws Exception {
		...
		testHasProblem(
			problems,
			JPQLQueryProblemMessages.NullComparisonExpression_InvalidCollectionExpression,
			startPosition,
			endPosition
		);
	}
	...
	public void test_StateFieldPathExpression_InvalidEnumConstant_1() throws Exception {
		...
		String query = "SELECT p FROM Product p WHERE p.enumType = com.titan.domain.EnumType.FIRST_NAME";
		List<JPQLQueryProblem> problems = validate(query);
	...
	public void test_StateFieldPathExpression_InvalidEnumConstant_2() throws Exception {
		...
		String query = "SELECT p FROM Product p WHERE p.enumType = com.titan.domain.EnumType.INVALID";
		int startPosition = "SELECT p FROM Product p WHERE p.enumType = com.titan.domain.EnumType.".length();
