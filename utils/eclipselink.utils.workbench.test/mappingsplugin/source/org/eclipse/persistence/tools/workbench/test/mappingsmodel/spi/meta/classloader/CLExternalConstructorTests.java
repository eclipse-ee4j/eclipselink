...
public class CLExternalConstructorTests extends ExternalConstructorTests {

	public static void main(String[] args) {
		TestRunner.main(new String[] {"-c", CLExternalConstructorTests.class.getName()});
	}
	
	public static Test suite() {
		return new TestSuite(CLExternalConstructorTests.class);
	}
	
	public CLExternalConstructorTests(String name) {
		super(name);
	}
