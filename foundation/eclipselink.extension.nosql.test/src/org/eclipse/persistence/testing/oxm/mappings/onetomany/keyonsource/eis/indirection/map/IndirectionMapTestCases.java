...
public class  IndirectionMapTestCases extends EISMappingTestCases {

  private final static String XML_RESOURCE = "org/eclipse/persistence/testing/oxm/mappings/onetomany/keyonsource/eis/indirection/map/writing/employee_control.xml";
  private final static String XML_TEST_RESOURCE="org/eclipse/persistence/testing/oxm/mappings/onetomany/keyonsource/eis/indirection/map/writing/employee.xml";
  ...
  public IndirectionMapTestCases(String name) throws Exception {
    super(name);
