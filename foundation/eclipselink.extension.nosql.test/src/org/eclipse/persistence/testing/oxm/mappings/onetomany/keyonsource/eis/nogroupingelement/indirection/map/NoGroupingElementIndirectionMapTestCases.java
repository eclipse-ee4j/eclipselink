...
public class NoGroupingElementIndirectionMapTestCases extends EISMappingTestCases {

  private final static String XML_RESOURCE = "org/eclipse/persistence/testing/oxm/mappings/onetomany/keyonsource/eis/nogroupingelement/indirection/map/writing/employee_control.xml";
  private final static String XML_TEST_RESOURCE="org/eclipse/persistence/testing/oxm/mappings/onetomany/keyonsource/eis/nogroupingelement/indirection/map/writing/employee.xml";
  ...
  public NoGroupingElementIndirectionMapTestCases(String name) throws Exception {
    super(name);
