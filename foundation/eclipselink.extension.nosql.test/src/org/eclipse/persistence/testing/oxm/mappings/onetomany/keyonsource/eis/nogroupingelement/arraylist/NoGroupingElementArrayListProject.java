...
public class NoGroupingElementArrayListProject extends org.eclipse.persistence.sessions.Project {

  public NoGroupingElementArrayListProject() {
    ...
    EISLogin login = new EISLogin(new XMLFilePlatform());
		...
		login.setProperty("directory", "./org/eclipse/persistence/testing/oxm/mappings/onetomany/keyonsource/eis/nogroupingelement/arraylist");
		setLogin(login);
  }
