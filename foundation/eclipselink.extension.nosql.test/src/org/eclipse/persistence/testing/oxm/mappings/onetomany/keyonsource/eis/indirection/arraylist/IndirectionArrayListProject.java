...
public class IndirectionArrayListProject extends org.eclipse.persistence.sessions.Project {

  public IndirectionArrayListProject() {
    ...
    EISLogin login = new EISLogin(new XMLFilePlatform());
		...
		login.setProperty("directory", "./org/eclipse/persistence/testing/oxm/mappings/onetomany/keyonsource/eis/indirection/arraylist/");
		setLogin(login);
  }
