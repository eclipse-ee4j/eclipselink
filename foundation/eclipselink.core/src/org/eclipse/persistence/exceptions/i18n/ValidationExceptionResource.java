...
public class ValidationExceptionResource extends ListResourceBundle {
    static final Object[][] contents = {
                                           ...
                                           { "7279", "Two converters called {0} were added to the project.  Only one converter of a given name may be added." },
                                           { "7280", "A StructConverter and a Converter of name {0} were added to the project.  StructConverters and Converters must have different names." },
