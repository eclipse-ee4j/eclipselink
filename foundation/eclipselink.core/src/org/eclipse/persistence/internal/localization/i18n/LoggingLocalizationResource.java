...
public class LoggingLocalizationResource extends ListResourceBundle {
    static final Object[][] contents = {
        ...
        { "one_to_one_join_outer_migrated", "The one-to-one outer join defined for cmr field ({0}) of entity bean ({1}) is not directly supported in TopLink CMP. See migration doc for details." },
        { "bacth_update_not_supported", "The Batch update setting batch-size with value ({0}) defined on entity bean ({1}) is not directly supported in TopLink CMP. See migration doc for details." },
        { "data_sync_on_ejb_create_not_supported", "The data syncronization setting data-synchronization-option='ejbCreate' defined on entity bean ({0}) is not directly supported in TopLink CMP. See migration doc for details." },
        ...
        { "annotation_warning_ignore_named_stored_procedure_query", "Ignoring the @NamedStoredProcedureQuery class [{1}] specified on [{0}] since a query with that name already exists." },
