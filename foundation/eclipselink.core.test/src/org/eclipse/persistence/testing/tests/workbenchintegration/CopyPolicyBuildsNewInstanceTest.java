 ...
 */
public class CopyPolicyBuildsNewInstanceTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public CopyPolicyBuildsNewInstanceTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.useCloneCopyPolicy(\"TestInstance\");");
        setDescription("Test addDescriptorPropertyLines method -> the buildsNewInstance");
    }
