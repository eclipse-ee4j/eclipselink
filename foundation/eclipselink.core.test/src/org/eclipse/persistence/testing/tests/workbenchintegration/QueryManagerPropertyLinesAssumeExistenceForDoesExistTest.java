 ...
 */
public class QueryManagerPropertyLinesAssumeExistenceForDoesExistTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;
    DatabaseMapping mappingToModify;

    public QueryManagerPropertyLinesAssumeExistenceForDoesExistTest() {
        ...
        setDescription("Test addQueryManagerPropertyLines method -> shouldAssumeExistenceForDoesExist()");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.getQueryManager().assumeExistenceForDoesExist();
    }
}
