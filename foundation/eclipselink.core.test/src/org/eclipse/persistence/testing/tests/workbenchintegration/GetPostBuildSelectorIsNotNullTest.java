 ...
 */
public class GetPostBuildSelectorIsNotNullTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public GetPostBuildSelectorIsNotNullTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.getEventManager().setPostBuildSelector(\"TestPostBuild\");");
        setDescription("Test addEventManagerPropertyLines method ->  getPostBuildSelector() != null");
    }
