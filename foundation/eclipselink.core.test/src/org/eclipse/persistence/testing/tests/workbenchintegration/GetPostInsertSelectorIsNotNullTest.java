 ...
 */
public class GetPostInsertSelectorIsNotNullTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public GetPostInsertSelectorIsNotNullTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.getEventManager().setPostInsertSelector(\"TestPostInsert\");");
        setDescription("Test addEventManagerPropertyLines method ->  getPostInsertSelector() != null");
    }
