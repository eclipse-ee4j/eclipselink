...
/**
 * This tests the performance of read-all queries in an unit of work.
 ...
 */
public class ReadAllUnitOfWorkEmployeeTest extends PerformanceTest {
    public ReadAllUnitOfWorkEmployeeTest() {
        setDescription("This tests the performance of read-all queries in a unit of work.");
    }
