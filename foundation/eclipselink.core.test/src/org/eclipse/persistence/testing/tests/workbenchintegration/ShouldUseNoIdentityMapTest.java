 ...
 */
public class ShouldUseNoIdentityMapTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public ShouldUseNoIdentityMapTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.useNoIdentityMap();");
        setDescription("Test addDescriptorPropertyLines method -> the shouldUseNoIdentityMap");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.useNoIdentityMap();
    }
}
