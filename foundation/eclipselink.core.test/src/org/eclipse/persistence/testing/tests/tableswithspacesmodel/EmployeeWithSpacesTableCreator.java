...
public class EmployeeWithSpacesTableCreator extends org.eclipse.persistence.tools.schemaframework.TableCreator {
     ...
     * Any changes will be lost when the code is re-generated
     */
    public EmployeeWithSpacesTableCreator(String quote) {
    ...
    protected void buildADDRESSTable() {
        ...
        // SECTION: TABLE
        tabledefinition.setName(quoteChar + "ADDRESS TABLE" + quoteChar);
    ...
    protected void buildEMPLOYEETable() {
        ...
        // SECTION: TABLE
        tabledefinition.setName(quoteChar + "EMPLOYEE TABLE" + quoteChar);
        ...
        field8.setForeignKeyFieldName(quoteChar + "ADDRESS TABLE" + quoteChar + ".ADDRESS_ID");
        ...
        field9.setForeignKeyFieldName(quoteChar + "EMPLOYEE TABLE" + quoteChar + ".EMP_ID");
    ...
    protected void buildLPROJECTTable() {
        ...
        // SECTION: TABLE
        tabledefinition.setName(quoteChar + "L PROJECT TABLE" + quoteChar);
        ...
        field.setForeignKeyFieldName(quoteChar + "PROJECT TABLE"  + quoteChar + ".PROJ_ID");
        tabledefinition.addField(field);
    ...
    protected void buildPHONETable() {
        ...
        // SECTION: TABLE
        tabledefinition.setName(quoteChar + "PHONE NUM" + quoteChar);
        ...
        field.setUnique(false);
        field.setIsIdentity(false);
        field.setForeignKeyFieldName(quoteChar + "EMPLOYEE TABLE" + quoteChar + ".EMP_ID");
        tabledefinition.addField(field);
    ...
    protected void buildPROJ_EMPTable() {
        ...
        // SECTION: TABLE
        tabledefinition.setName(quoteChar + "PROJ EMP" + quoteChar);
        ...
        field1.setUnique(false);
        field1.setIsIdentity(false);
        field1.setForeignKeyFieldName(quoteChar + "PROJECT TABLE"  + quoteChar + ".PROJ_ID");
        tabledefinition.addField(field1);
        addTableDefinition(tabledefinition);
    }
    ...
    protected void buildPROJECTTable() {
        ...
        // SECTION: TABLE
        tabledefinition.setName(quoteChar + "PROJECT TABLE"  + quoteChar);
        ...
        field4.setUnique(false);
        field4.setIsIdentity(false);
        field4.setForeignKeyFieldName(quoteChar + "EMPLOYEE TABLE" + quoteChar + ".EMP_ID");
        tabledefinition.addField(field4);
    ...
    protected void buildRESPONSTable() {
        ...
        // SECTION: TABLE
        tabledefinition.setName(quoteChar + "RESPONS TABLE" + quoteChar);
    ...
    protected void buildSALARYTable() {
        ...
        // SECTION: TABLE
        tabledefinition.setName(quoteChar + "SALARY TABLE" + quoteChar);
