 ...
 */
public class JMSConnectionExceptionHandlingTest extends TestCase {
    ...
    public JMSConnectionExceptionHandlingTest(String method) {
        m_methodName = method;
        m_paramTypes = null;
        m_params = null;
        setName("JMSConnectionExceptionHandlingTest - " + m_methodName);
    }

    public JMSConnectionExceptionHandlingTest(String method, Class[] paramTypes, Object[] params) {
        m_methodName = method;
