 ...
 */
public class ShouldAlwaysConformResultsInUnitOfWorkTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public ShouldAlwaysConformResultsInUnitOfWorkTest() {
        ...
        setDescription("Test addDescriptorPropertyLines method -> the shouldAlwaysConformResultsOnUnitOfWork");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.alwaysConformResultsInUnitOfWork();
    }
}
