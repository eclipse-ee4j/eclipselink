 ...
 */
public class GetPreDeleteSelectorIsNotNullTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public GetPreDeleteSelectorIsNotNullTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.getEventManager().setPreDeleteSelector(\"TestPreDelete\");");
        setDescription("Test addEventManagerPropertyLines method ->  getPreDeleteSelector() != null");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.getEventManager().setPreDeleteSelector("TestPreDelete");
    }
}
