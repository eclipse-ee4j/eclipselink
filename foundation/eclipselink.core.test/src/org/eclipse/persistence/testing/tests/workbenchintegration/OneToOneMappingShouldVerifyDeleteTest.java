 ...
 */
public class OneToOneMappingShouldVerifyDeleteTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;
    DatabaseMapping mappingToModify;

    public OneToOneMappingShouldVerifyDeleteTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              ".setShouldVerifyDelete(false);");
        setDescription("Test addOneToOneMappingLines method ->ShouldVerifyDelete");
    }
