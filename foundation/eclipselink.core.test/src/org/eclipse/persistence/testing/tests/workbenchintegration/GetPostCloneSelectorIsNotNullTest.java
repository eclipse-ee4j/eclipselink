 ...
 */
public class GetPostCloneSelectorIsNotNullTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public GetPostCloneSelectorIsNotNullTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.getEventManager().setPostCloneSelector(\"TestPostClone\");");
        setDescription("Test addEventManagerPropertyLines method ->  getPostCloneSelector() != null");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.getEventManager().setPostCloneSelector("TestPostClone");
    }
}
