...
public abstract class ObjectLevelReadQueryTest extends TestCase {
    ...
    /**
     * Creates {@link TestSuite} for this test.
     * @return {@link TestSuite} with all tests.
     */
    public static Test suite() {
        TestSuite suite = new TestSuite();
        suite.addTestSuite(CustomQueryRaceConditionsInReadAllQueryTest.class);
        suite.addTestSuite(CustomQueryRaceConditionsInReadObjectQueryTest.class);
        return suite;
    }
