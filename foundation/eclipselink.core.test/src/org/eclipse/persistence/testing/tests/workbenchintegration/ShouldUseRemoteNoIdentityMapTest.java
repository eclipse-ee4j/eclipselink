 ...
 */
public class ShouldUseRemoteNoIdentityMapTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public ShouldUseRemoteNoIdentityMapTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.useRemoteNoIdentityMap();");
        setDescription("Test addDescriptorPropertyLines method -> the shouldUseRemoteNoIdentityMap");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.useRemoteNoIdentityMap();
    }
}
