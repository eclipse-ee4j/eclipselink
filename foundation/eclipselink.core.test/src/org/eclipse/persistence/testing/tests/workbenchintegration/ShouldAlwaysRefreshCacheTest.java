 ...
 */
public class ShouldAlwaysRefreshCacheTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public ShouldAlwaysRefreshCacheTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.alwaysRefreshCache();");
        setDescription("Test addDescriptorPropertyLines method -> the shouldAlwaysRefreshCache");
    }
