...
public class IllegalArgumentWhileSettingValueThruInstanceVariableAccessorTest extends ExceptionTest {
    public IllegalArgumentWhileSettingValueThruInstanceVariableAccessorTest() {

        super();
        setDescription("This tests Illegal Argument While Setting Value Thru Instance Variable Accessor (TL-ERROR 32)");
    }
