 ...
 */
public class ShouldOnlyRefreshCacheIfNewerVersionTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public ShouldOnlyRefreshCacheIfNewerVersionTest() {
        ...
        setDescription("Test addDescriptorPropertyLines method -> the shouldOnlyRefreshCacheIfNewerVersion");
    }
