 ...
 */
public class FactoryMethodNameIsNotNullTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public FactoryMethodNameIsNotNullTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.useFactoryInstantiationPolicy(org.eclipse.persistence.testing.models.employee.domain.Employee.class, \"TestMethod\", \"TestFactoryMethodName\");");
        setDescription("Test addDescriptorPropertyLines method -> the factoryMethod != null");
    }
