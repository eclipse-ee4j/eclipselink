...
/**
 * Do the basic InsertObjectTest except on a multiple table. The method of setting up the multiple tables
 * can be chosen by passing the amendment method name in the constructor.
 */
public class MultipleTableInsertObjectTest extends org.eclipse.persistence.testing.framework.InsertObjectTest {
    String amendmentMethodName;

    public MultipleTableInsertObjectTest(Object originalObject, String amendmentMethodName) {
        super(originalObject);
        this.amendmentMethodName = amendmentMethodName;
        setName("MultipleTableInsertObjectTest(" + amendmentMethodName + "," + originalObject + ")");
    }
