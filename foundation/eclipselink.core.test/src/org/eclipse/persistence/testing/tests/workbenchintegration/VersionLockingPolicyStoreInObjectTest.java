 ...
 */
public class VersionLockingPolicyStoreInObjectTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;
    DatabaseMapping mappingToModify;

    public VersionLockingPolicyStoreInObjectTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "lockingPolicy.storeInObject();");
        setDescription("Test addOptimisticLockingLines method ->VersionLockingPolicy isStoredInObject()");
    }
