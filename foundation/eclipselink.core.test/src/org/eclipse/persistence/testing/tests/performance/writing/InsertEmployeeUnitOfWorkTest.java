 ...
 */
public class InsertEmployeeUnitOfWorkTest extends PerformanceTest {
    public InsertEmployeeUnitOfWorkTest() {
    ...
    public void test() throws Exception {
        ...
        getSession().executeNonSelectingCall(new SQLCall("Delete from EMPLOYEE where F_NAME = 'NewGuy'"));
    }
}
