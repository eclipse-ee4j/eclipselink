 ...
 */
public class QueryKeyIsAbstractQueryKeyTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;
    DatabaseMapping mappingToModify;

    public QueryKeyIsAbstractQueryKeyTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.addAbstractQueryKey(\"Test query key\");");
        setDescription("Test addQueryKeyLines method -> isAbstractQueryKey()");
    }
