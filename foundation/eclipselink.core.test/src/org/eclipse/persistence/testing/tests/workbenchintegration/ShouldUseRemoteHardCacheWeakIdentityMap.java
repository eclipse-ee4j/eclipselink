 ...
 */
public class ShouldUseRemoteHardCacheWeakIdentityMap extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public ShouldUseRemoteHardCacheWeakIdentityMap() {
        ...
        setDescription("Test addDescriptorPropertyLines method -> the shouldUseRemoteHardCacheWeakIdentityMap");
    }
