 ...
 */
public class TransformationMappingUsesBasicIndirectionTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;
    DatabaseMapping mappingToModify;

    public TransformationMappingUsesBasicIndirectionTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), ".useBasicIndirection();");
        setDescription("Test addTransformationMappingLines method -> Mapping.useBasicIndirection");
    }
