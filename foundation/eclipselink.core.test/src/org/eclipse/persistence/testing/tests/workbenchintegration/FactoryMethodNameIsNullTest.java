 ...
 */
public class FactoryMethodNameIsNullTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public FactoryMethodNameIsNullTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.useFactoryInstantiationPolicy(org.eclipse.persistence.testing.models.employee.domain.Employee.class, \"TestMethod\");");
