 ...
 */
public class ShouldDisableCacheHitsOnRemoteTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public ShouldDisableCacheHitsOnRemoteTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.disableCacheHitsOnRemote();");
        setDescription("Test addDescriptorPropertyLines method -> the shouldDisableCacheHitsOnRemote");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.disableCacheHitsOnRemote();
    }
}
