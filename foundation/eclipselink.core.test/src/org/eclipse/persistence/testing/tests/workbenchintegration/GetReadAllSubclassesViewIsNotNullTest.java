 ...
 */
public class GetReadAllSubclassesViewIsNotNullTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public GetReadAllSubclassesViewIsNotNullTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.getInheritancePolicy().setReadAllSubclassesViewName(\"Testing  getReadAllSubclassesView ()\");");
        setDescription("Test addInheritanceLines method ->  getReadAllSubclassesView != null");
    }
