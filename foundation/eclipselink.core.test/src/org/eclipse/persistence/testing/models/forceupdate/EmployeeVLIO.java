...
public class EmployeeVLIO implements Serializable {
    ...
    public void addPhoneNumber(PhoneNumberVLIO phoneNumber) {
        getPhoneNumbers().addElement(phoneNumber);
        phoneNumber.setOwner(this);
    }

    public AddressVLIO getAddress() {
        return (AddressVLIO)address.getValue();
    }
    ...
    public void removePhoneNumber(PhoneNumberVLIO phoneNumber) {
        getPhoneNumbers().removeElement(phoneNumber);
    }

    public void setAddress(AddressVLIO address) {
