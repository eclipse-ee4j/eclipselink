 ...
 *								Employee.
 */
public class PhoneNumberTLIC implements Serializable {
    ...
    public PhoneNumberTLIC() {
        this("home", "###", "#######");
    }

    public PhoneNumberTLIC(String type, String theAreaCode, String theNumber) {
        this.type = type;
    ...
    public org.eclipse.persistence.testing.models.forceupdate.EmployeeTLIC getOwner() {
        return (EmployeeTLIC)owner.getValue();
    }
    ...
    public void setOwner(org.eclipse.persistence.testing.models.forceupdate.EmployeeTLIC owner) {
