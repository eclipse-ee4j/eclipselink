 ...
 *								Employee.
 */
public class PhoneNumberTLIO implements Serializable {
    ...
    public PhoneNumberTLIO() {
        this("home", "###", "#######");
    }

    public PhoneNumberTLIO(String type, String theAreaCode, String theNumber) {
        this.type = type;
    ...
    public org.eclipse.persistence.testing.models.forceupdate.EmployeeTLIO getOwner() {
        return (EmployeeTLIO)owner.getValue();
    }
    ...
    public void setOwner(org.eclipse.persistence.testing.models.forceupdate.EmployeeTLIO owner) {
