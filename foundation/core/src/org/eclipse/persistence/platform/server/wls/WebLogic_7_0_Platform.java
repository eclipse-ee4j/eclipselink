 ...
 * PUBLIC:
 *
 * This is the concrete subclass responsible for representing WebLogic70 specific behaviour.
 *
 */
public class WebLogic_7_0_Platform extends WebLogicPlatform {
    /**
     * INTERNAL:
     * Default Constructor: All behaviour for the default constructor is inherited
     */
    public WebLogic_7_0_Platform(DatabaseSession newDatabaseSession) {
