...
public class EclipseLinkIdentityHashMap extends AbstractMap implements Map, Cloneable, Serializable {
    ...
    /**
     * Constructs a new <tt>EclipseLinkIdentityHashMap</tt> with the given
     * initial capacity and the given loadFactor.
     *
     * @param initialCapacity the initial capacity of this
     * <tt>EclipseLinkIdentityHashMap</tt>.
     * @param loadFactor the loadFactor of the <tt>EclipseLinkIdentityHashMap</tt>.
     * @throws IllegalArgumentException  if the initial capacity is less
     * than zero, or if the loadFactor is nonpositive.
     */
    public EclipseLinkIdentityHashMap(int initialCapacity, float loadFactor) {
     ...
     * than zero.
     */
    public EclipseLinkIdentityHashMap(int initialCapacity) {
        this(initialCapacity, DEFAULT_LOAD_FACTOR);
    }

    /**
     * Constructs a new <tt>EclipseLinkIdentityHashMap</tt> with a default initial
     * capacity of <tt>32</tt> and a loadfactor of <tt>0.75</tt>.
     */
    public EclipseLinkIdentityHashMap() {
    ...
    /**
     * Constructs a new <tt>EclipseLinkIdentityHashMap</tt> with the same mappings
     * as the given map.  The <tt>EclipseLinkIdentityHashMap</tt> is created with a
     * capacity sufficient to hold the elements of the given map.
     *
     * @param m the map whose mappings are to be placed in the
     * <tt>EclipseLinkIdentityHashMap</tt>.
     */
    public EclipseLinkIdentityHashMap(Map m) {
        this(Math.max((int)(m.size() / DEFAULT_LOAD_FACTOR) + 1, DEFAULT_INITIAL_CAPACITY), DEFAULT_LOAD_FACTOR);
        putAll(m);
    }

    /**
     * @return the size of this <tt>EclipseLinkIdentityHashMap</tt>.
     */
    public int size() {
        return count;
    }
    ...
    /**
     * @return <tt>true</tt> if this <tt>EclipseLinkIdentityHashMap</tt> is empty.
     */
    ...
    /**
     * Returns <tt>true</tt> if this <tt>EclipseLinkIdentityHashMap</tt> contains
     * the given object. Equality is tested by the equals() method.
     *
     * @param obj the object to find.
     * @return <tt>true</tt> if this <tt>EclipseLinkIdentityHashMap</tt> contains
     * obj.
    ...
    /**
     * Returns <tt>true</tt> if this <tt>EclipseLinkIdentityHashMap</tt> contains a
     * mapping for the given key. Equality is tested by reference.
     *
     * @param key object to be used as a key into this
     * <tt>EclipseLinkIdentityHashMap</tt>.
     * @return <tt>true</tt> if this <tt>EclipseLinkIdentityHashMap</tt> contains a
     * mapping for key.
     */
     ...
     * <tt>EclipseLinkIdentityHashMap</tt>. Returns <tt>null</tt> if this
     * <tt>EclipseLinkIdentityHashMap</tt> contains no mapping for this key.
     *
     * @return the value to which this <tt>EclipseLinkIdentityHashMap</tt> maps the
     * given key.
     ...
     * EclipseLinkIdentityHashMap exceeds its current threshold.
     */
    private void rehash() {
     ...
     * <tt>EclipseLinkIdentityHashMap</tt>, replacing any existing mapping.
     *
     ...
     * <tt>EclipseLinkIdentityHashMap</tt> did not have one.
     * @throws <tt>NullPointerException</tt> if obj is null</tt>.
     */
     ...
     * <tt>EclipseLinkIdentityHashMap</tt>, if present.
     *
     ...
     * <tt>EclipseLinkIdentityHashMap</tt>, replacing any existing mappings.
     *
     * @param m mappings to be stored in this <tt>EclipseLinkIdentityHashMap</tt>.
    ...
    /**
     * Removes all of the mappings from this <tt>EclipseLinkIdentityHashMap</tt>.
     */
    public void clear() {
        if (count > 0) {
            modCount++;
    ...
    /**
     * Returns a shallow copy of this <tt>EclipseLinkIdentityHashMap</tt> (the
     * elements are not cloned).
     *
     * @return a shallow copy of this <tt>EclipseLinkIdentityHashMap</tt>.
     */
    public Object clone() {
        try {
            Entry[] copyOfEntries = entries;
            EclipseLinkIdentityHashMap clone = (EclipseLinkIdentityHashMap)super.clone();
     ...
     * <tt>EclipseLinkIdentityHashMap</tt>.  The set is backed by the map, so
        ...
        if (keySet == null) {
            keySet = new AbstractSet() {
                        ...
                        public boolean remove(Object o) {
                            int oldSize = count;
                            EclipseLinkIdentityHashMap.this.remove(o);
                            return count != oldSize;
                        }

                        public void clear() {
                            EclipseLinkIdentityHashMap.this.clear();
                        }
                    };
        }
        return keySet;
     ...
     * <tt>EclipseLinkIdentityHashMap</tt>.  The collection is backed by the map, so
     ...
     * <tt>EclipseLinkIdentityHashMap</tt>.  Each element in the returned collection
    ...
    /**
     * EclipseLinkIdentityHashMap entry.
     */
    ...
    private class HashIterator implements Iterator {
        Entry[] entries = EclipseLinkIdentityHashMap.this.entries;
        ...
        public boolean hasNext() {
            Entry e = entry;
            int i = index;
            Entry[] copyOfEntries = EclipseLinkIdentityHashMap.this.entries;
            while ((e == null) && (i > 0)) {
                e = copyOfEntries[--i];
            }
            entry = e;
    ...
    /**
     * Serialize the state of this <tt>EclipseLinkIdentityHashMap</tt> to a stream.
     *
     * @serialData The <i>capacity</i> of the <tt>EclipseLinkIdentityHashMap</tt>
     * (the length of the bucket array) is emitted (int), followed by the
     * <i>size</i> of the <tt>EclipseLinkIdentityHashMap</tt>, followed by the
    ...
    /**
     * Deserialize the <tt>EclipseLinkIdentityHashMap</tt> from a stream.
     */
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        // Read the mappings and add to the EclipseLinkIdentityHashMap
