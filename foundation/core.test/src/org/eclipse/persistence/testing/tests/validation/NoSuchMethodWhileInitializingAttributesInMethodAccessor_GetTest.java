...
public class NoSuchMethodWhileInitializingAttributesInMethodAccessor_GetTest extends ExceptionTest {
    public NoSuchMethodWhileInitializingAttributesInMethodAccessor_GetTest() {
        super();
