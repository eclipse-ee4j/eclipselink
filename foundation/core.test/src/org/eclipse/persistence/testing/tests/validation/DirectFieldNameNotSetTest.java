...
public class DirectFieldNameNotSetTest extends ExceptionTest {
    public DirectFieldNameNotSetTest() {
        super();
        setDescription("This tests Direct Field Name Not Set (TL-ERROR 09) " + "");
