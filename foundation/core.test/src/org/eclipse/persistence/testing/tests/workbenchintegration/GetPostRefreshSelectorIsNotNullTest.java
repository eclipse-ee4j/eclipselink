 ...
 */
public class GetPostRefreshSelectorIsNotNullTest extends ProjectClassGeneratorResultFileTest {
    ClassDescriptor descriptorToModify;

    public GetPostRefreshSelectorIsNotNullTest() {
        super(new org.eclipse.persistence.testing.models.employee.relational.EmployeeProject(), 
              "descriptor.getEventManager().setPostRefreshSelector(\"TestPostRefresh\");");
        setDescription("Test addEventManagerPropertyLines method ->  getPostRefreshSelector() != null");
    }
    ...
    protected void setup() {
        ...
        descriptorToModify.getEventManager().setPostRefreshSelector("TestPostRefresh");
    }
}
