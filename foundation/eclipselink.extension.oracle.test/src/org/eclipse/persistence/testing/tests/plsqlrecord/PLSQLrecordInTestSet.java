...
public class PLSQLrecordInTestSet  {
    ...
    public static final String PLSQLRECORD_IN_PROJECT_XML =
         ...
         "<eclipselink:class-mapping-descriptors>" +
            "<eclipselink:class-mapping-descriptor xsi:type=\"eclipselink:object-relational-class-mapping-descriptor\">" +
               ...
               "<eclipselink:querying xsi:type=\"eclipselink:query-policy\">" +
                  "<eclipselink:queries>" +
                     "<eclipselink:query name=\"PLSQLrecordIn\" xsi:type=\"eclipselink:data-modify-query\">" +
    ...
    public void readFromXml() {
        Project projectFromXML = XMLProjectReader.read(new StringReader(PLSQLRECORD_IN_PROJECT_XML),
    ...
    public void runQuery() {
        ...
        String msg = null;
        try {
            s.executeQuery("PLSQLrecordIn", PLSQLEmployeeType.class, queryArgs);
            worked = true;
        }
        catch (Exception e) {
            msg = e.getMessage();
