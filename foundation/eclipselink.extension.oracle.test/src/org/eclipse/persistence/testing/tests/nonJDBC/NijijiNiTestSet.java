...
public class NijijiNiTestSet {
    ...
    public void writeToXml() {
        // (x in boolean, y in varchar, z in number, aa in pls_integer)
        PLSQLStoredProcedureCall call = new PLSQLStoredProcedureCall();
        call.setProcedureName("nijijini");
        call.addNamedArgument("X", OraclePLSQLTypes.PLSQLBoolean);
        call.addNamedArgument("Y", JDBCTypes.VARCHAR_TYPE, 20);
        call.addNamedArgument("Z", JDBCTypes.NUMERIC_TYPE, 20, 2);
        call.addNamedArgument("AA", OraclePLSQLTypes.PLSQLInteger);
        ...
        Document controlDoc = xmlParser.parse(new StringReader(NIJIJINI_PROJECT_XML));
        assertTrue("control document not same as instance document",
            comparer.isNodeEqual(controlDoc, doc));
    }
    public static final String NIJIJINI_PROJECT_XML =
             ...
             "<eclipselink:class-mapping-descriptor xsi:type=\"eclipselink:relational-class-mapping-descriptor\">" +
                ...
                "</eclipselink:primary-key>" +
                 ...
                 "<eclipselink:querying xsi:type=\"eclipselink:query-policy\">" +
                    "<eclipselink:queries>" +
                       "<eclipselink:query name=\"NijijiNi\" xsi:type=\"eclipselink:data-modify-query\">" +
                         ...
                         "<eclipselink:call xsi:type=\"eclipselink:plsql-stored-procedure-call\">" +
                           "<eclipselink:procedure-name>nijijini</eclipselink:procedure-name>" +
                           "<eclipselink:arguments>" +
    ...
    public void readFromXml() {
        Project projectFromXML = XMLProjectReader.read(new StringReader(NIJIJINI_PROJECT_XML),
