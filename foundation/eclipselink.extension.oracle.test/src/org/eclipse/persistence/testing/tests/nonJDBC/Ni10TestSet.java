...
public class Ni10TestSet {
    ...
    public void writeToXml() {
        ...
        call.setProcedureName("signtype_in_test");
        call.addNamedArgument("Y", OraclePLSQLTypes.SignType);
        ...
        Document controlDoc = xmlParser.parse(new StringReader(NI10_PROJECT_XML));
        assertTrue("control document not same as instance document",
            comparer.isNodeEqual(controlDoc, doc));
    }
    public static final String NI10_PROJECT_XML =
             ...
             "<eclipselink:class-mapping-descriptor xsi:type=\"eclipselink:relational-class-mapping-descriptor\">" +
                ...
                "</eclipselink:primary-key>" +
                 ...
                 "<eclipselink:querying xsi:type=\"eclipselink:query-policy\">" +
                    "<eclipselink:queries>" +
                       "<eclipselink:query name=\"Ni10\" xsi:type=\"eclipselink:data-modify-query\">" +
                          ...
                          "<eclipselink:call xsi:type=\"eclipselink:plsql-stored-procedure-call\">" +
                             "<eclipselink:procedure-name>signtype_in_test</eclipselink:procedure-name>" +
                             "<eclipselink:arguments>" +
                                "<eclipselink:argument xsi:type=\"eclipselink:plsql-type\" type-name=\"SignType\">" +
    ...
    public void readFromXml() {
        Project projectFromXML = XMLProjectReader.read(new StringReader(NI10_PROJECT_XML),
