...
public class Ni3TestSet {
    ...
    public void writeToXml() {
        ...
        call.setProcedureName("binaryint_in_test");
        ...
        Document controlDoc = xmlParser.parse(new StringReader(NI3_PROJECT_XML));
        assertTrue("control document not same as instance document",
            comparer.isNodeEqual(controlDoc, doc));
    }
    public static final String NI3_PROJECT_XML =
             ...
             "<eclipselink:class-mapping-descriptor xsi:type=\"eclipselink:relational-class-mapping-descriptor\">" +
                ...
                "</eclipselink:primary-key>" +
                 ...
                 "<eclipselink:querying xsi:type=\"eclipselink:query-policy\">" +
                    "<eclipselink:queries>" +
                       "<eclipselink:query name=\"Ni3\" xsi:type=\"eclipselink:data-modify-query\">" +
                          ...
                          "<eclipselink:call xsi:type=\"eclipselink:plsql-stored-procedure-call\">" +
                             "<eclipselink:procedure-name>binaryint_in_test</eclipselink:procedure-name>" +
                             "<eclipselink:arguments>" +
    ...
    public void readFromXml() {
        Project projectFromXML = XMLProjectReader.read(new StringReader(NI3_PROJECT_XML),
    ...
    public void runQuery() {
        ...
        String msg = null;
        try {
          s.executeQuery("Ni3", Empty.class, queryArgs);
          worked = true;
        }
        catch (Exception e) {
          msg = e.getMessage();
