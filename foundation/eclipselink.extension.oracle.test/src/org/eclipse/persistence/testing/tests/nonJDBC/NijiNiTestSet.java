...
public class NijiNiTestSet {
    ...
    public void writeToXml() {
        // (x in boolean, y in varchar, z in binary_integer)
        PLSQLStoredProcedureCall call = new PLSQLStoredProcedureCall();
        call.setProcedureName("nijini");
        call.addNamedArgument("X", OraclePLSQLTypes.PLSQLBoolean );
        call.addNamedArgument("Y", JDBCTypes.VARCHAR_TYPE, 20);
        call.addNamedArgument("Z", OraclePLSQLTypes.BinaryInteger );
        ...
        Document controlDoc = xmlParser.parse(new StringReader(NIJINI_PROJECT_XML));
        assertTrue("control document not same as instance document",
            comparer.isNodeEqual(controlDoc, doc));
    }
    public static final String NIJINI_PROJECT_XML =
             ...
             "<eclipselink:class-mapping-descriptor xsi:type=\"eclipselink:relational-class-mapping-descriptor\">" +
                ...
                "</eclipselink:primary-key>" +
                 ...
                 "<eclipselink:querying xsi:type=\"eclipselink:query-policy\">" +
                    "<eclipselink:queries>" +
                       "<eclipselink:query name=\"NijiNi\" xsi:type=\"eclipselink:data-modify-query\">" +
                          ...
                          "<eclipselink:call xsi:type=\"eclipselink:plsql-stored-procedure-call\">" +
                             "<eclipselink:procedure-name>nijini</eclipselink:procedure-name>" +
                             "<eclipselink:arguments>" +
    ...
    public void readFromXml() {
        Project projectFromXML = XMLProjectReader.read(new StringReader(NIJINI_PROJECT_XML),
    ...
    public void runQuery() {
        ...
        String msg = null;
        try {
          s.executeQuery("NijiNi", Empty.class, queryArgs);
          worked = true;
        }
        catch (Exception e) {
          msg = e.getMessage();
