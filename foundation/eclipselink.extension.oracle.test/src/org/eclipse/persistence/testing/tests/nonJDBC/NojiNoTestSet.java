...
public class NojiNoTestSet {
    ...
    public void writeToXml() {
        // PROCEDURE NOJINO(X OUT BINARY_INTEGER, Y IN VARCHAR, Z OUT BOOLEAN)
        PLSQLStoredProcedureCall call = new PLSQLStoredProcedureCall();
        call.setProcedureName("NojiNo");
        call.addNamedOutputArgument("X", OraclePLSQLTypes.BinaryInteger);
        call.addNamedArgument("Y", JDBCTypes.VARCHAR_TYPE, 40);
        call.addNamedOutputArgument("Z", OraclePLSQLTypes.PLSQLBoolean);
        ...
        Document controlDoc = xmlParser.parse(new StringReader(NOJINO_PROJECT_XML));
        assertTrue("control document not same as instance document",
            comparer.isNodeEqual(controlDoc, doc));
    }
    public static final String NOJINO_PROJECT_XML =
          ...
          "<eclipselink:class-mapping-descriptors>" +
            "<eclipselink:class-mapping-descriptor xsi:type=\"eclipselink:relational-class-mapping-descriptor\">" +
              ...
              "<eclipselink:querying xsi:type=\"eclipselink:query-policy\">" +
                "<eclipselink:queries>" +
                  "<eclipselink:query name=\"NojiNo\" xsi:type=\"eclipselink:data-read-query\">" +
                    ...
                    "<eclipselink:call xsi:type=\"eclipselink:plsql-stored-procedure-call\">" +
                      "<eclipselink:procedure-name>NojiNo</eclipselink:procedure-name>" +
                      "<eclipselink:arguments>" +
    ...
    public void readFromXml() {
        Project projectFromXML = XMLProjectReader.read(new StringReader(NOJINO_PROJECT_XML),
