...
public class NoSQLTestSuite extends JUnitTestCase {
    ...
    public static Test suite() {
        ...
        suite.setName("NoSQLTestSuite");
        suite.addTest(new NoSQLTestSuite("testSetup"));
        suite.addTest(new NoSQLTestSuite("testInsert"));
        suite.addTest(new NoSQLTestSuite("testFind"));
        suite.addTest(new NoSQLTestSuite("testUpdate"));
        suite.addTest(new NoSQLTestSuite("testMerge"));
        suite.addTest(new NoSQLTestSuite("testRefresh"));
        suite.addTest(new NoSQLTestSuite("testDelete"));
        suite.addTest(new NoSQLTestSuite("testJPQL"));
