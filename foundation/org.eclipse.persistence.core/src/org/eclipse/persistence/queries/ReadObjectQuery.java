            ...
            if (!this.isUserDefined) {
                if (!isCallQuery()) {
                    ...
                    if (descriptorQueryManager.hasReadObjectQuery()) {
                        ...
                        if ((!hasJoining() || !this.joinedAttributeManager.hasJoinedAttributeExpressions()) && (!hasPartialAttributeExpressions()) && (redirector == null) && (!hasAsOfClause()) && (!hasNonDefaultFetchGroup())
