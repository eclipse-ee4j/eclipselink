...
public class EclipseLinkObjectPersistenceRuntimeXMLProject extends Project {
    ...
    protected ClassDescriptor buildAbstractDirectMappingDescriptor() {
		...
		attributeClassificationMapping.setXPath("eclipselink:attribute-classification/text()");
    ...
    protected ClassDescriptor buildConverterDescriptor() {
		...
		try {
			Class typesafeenumClass = (Class) new PrivilegedClassForName("org.eclipse.persistence.jaxb.JAXBTypesafeEnumConverter").run();
			descriptor.getInheritancePolicy().addClassIndicator(typesafeenumClass,"eclipselink:typesafe-enumeration-converter");
		} catch (ClassNotFoundException cnfe) {
			// The JAXB component isn't available, so no need to do anything
		}
    ...
    protected ClassDescriptor buildXMLCompositeObjectMappingDescriptor() {
        ...
        nullPolicyClassMapping.setXPath("eclipselink:null-policy");
    ...
    protected ClassDescriptor buildAbstractNullPolicyDescriptor() {
         ...
         aDescriptor.getInheritancePolicy().addClassIndicator(NullPolicy.class, "eclipselink:null-policy");
     ...
     protected ClassDescriptor buildIsSetNullPolicyDescriptor() {
         ...
         isSetMethodNameMapping.setXPath("eclipselink:is-set-method-name/text()");
