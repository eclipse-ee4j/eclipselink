...
public class ValidationException extends EclipseLinkException {
    ...
    */
    ...
    public static ValidationException errorParsingMappingFile(String mappingFile, Exception orm2Error, Exception orm1Error, Exception eclipselinkError) {
        Object[] args = { mappingFile, orm1Error, eclipselinkError };
    ...
    */
    ...
    public static ValidationException conflictingAccessTypeForEmbeddable(Object embeddableClass, boolean embeddableAccessType, Object descriptorClass, boolean descriptorAccessType) {
