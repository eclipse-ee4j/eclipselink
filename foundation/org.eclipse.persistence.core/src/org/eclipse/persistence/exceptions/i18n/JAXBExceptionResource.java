...
public class JAXBExceptionResource extends ListResourceBundle {
    static final Object[][] contents = {
        ...
        {"50072", "An exception was thrown during Marshal operation. If the JAXBContext was bootstrapped using TypeMappingInfo[], you must call a marshal method that accepts TypeMappingInfo as an input parameter."}
    };
