...
public class ValidationExceptionResource extends ListResourceBundle {
    static final Object[][] contents = {
                                           ...
                                           { "7197", "Null pointer encountered in unit of work clone."},
                                           ...
                                           { "7204", "Multiple named queries with the name [{0}] were found. One within [{1}] and the other within [{2}]."},
                                           { "7205", "Multiple named native queries with the name [{0}] were found. One within [{1}] and the other within [{2}]."},
                                           { "7206", "Multiple named stored procedure queries with the name [{0}] were found. One within [{1}] and the other within [{2}]."},
                                           ...
                                           { "7209", "Multiple attribute override with the same name {[0]} were defined for the class {[1]}. They were found at the following location {[2]} "},
                                           { "7210", "Multiple association override with the same name {[0]} were defined for the class {[1]}. They were found at the following location {[2]}"},
                                           ...
                                           { "7279", "Two converters with the same name [{0}] were found. One was found here [{1}] and the other here [{2}]. All converters (Converter, TypeConverter, ObjectTypeConverter and StructConverter) must have unique names across the persistence unit. Please rename or remove one of the converters." },
