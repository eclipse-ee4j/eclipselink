...
public class ValidationExceptionResource extends ListResourceBundle {
    static final Object[][] contents = {
                                           ...
                                           { "7082", "The EclipseLink properties file [{0}] specified multiple project files for the server named [{1}].  Please specify one of [projectClass], [projectFile], or [xmlProjectFile]." },
                                           { "7083", "The EclipseLink properties file [{0}] did not include any information on the EclipseLink project to use for the server named [{1}].  Please specify one of [projectClass], [projectFile], or [xmlProjectFile]." },
                                           ...
                                           { "7161", "Entity class [{0}] has no primary key specified. It should define either an @Id, @EmbeddedId or an @IdClass." +
                                                     " If you have defined PK using any of these annotations then please make sure that you do not have " +
                                           ...
                                           { "7287", "The read transformer specified for the element [{0}] doesn't implement required interface AttributeTransformer."},
                                           ...
                                           { "7290", "The write transformer specified for the column [{1}] of element [{0}] doesn't implement required interface FieldTransformer."},
                                           ...
                                           { "7293", "The write transformer specified for the elment [{0}] either doesn''t have a column or the column doesn't have name."},
