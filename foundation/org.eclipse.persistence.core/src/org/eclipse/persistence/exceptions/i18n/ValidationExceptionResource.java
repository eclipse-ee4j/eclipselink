...
public class ValidationExceptionResource extends ListResourceBundle {
    static final Object[][] contents = {
                                           ...
                                           { "7069", "An exception occurred looking up or invoking the project amendment method, [{0}] on the class [{1}]." },
                                           { "7070", "An EclipseLink.properties resource bundle must be located on the CLASSPATH in an EclipseLink directory." },
                                           ...
                                           { "7078", "The \"sessionName\" [{0}], specified on the deployment descriptor for [{1}], does not match any session specified in the EclipseLink properties file." },
                                           ...
                                           { "7082", "The EclipseLink properties file [{0}] specified multiple project files for the server named [{1}].  Specify one of [projectClass], [projectFile], or [xmlProjectFile]." },
                                           { "7083", "The EclipseLink properties file [{0}] did not include any information on the EclipseLink project to use for the server named [{1}].  Specify one of [projectClass], [projectFile], or [xmlProjectFile]." },
                                           { "7084", "The file [{0}] is not a valid type for reading.  ProjectReader must be given the deployed XML Project file." },
                                           { "7085", "At least one sub session need to be defined in the EclipseLink session broker {0}" },
                                           ...
                                           { "7112", "You have specified that Eclipselink use the feature : {0}, but this feature is not available in the currently running JDK version :{1}." },
                                           ...
                                           { "7142", "{0} sequence can not be set as default, because a sequence with that name has been already added" },
                                           { "7143", "{0} sequence can not be added, because a sequence with that name has been already set as default." },
                                           ...
                                           { "7166", "A table generator that uses the reserved name [{0}] for its 'name' has been found in [{1}]. It cannot use this name because it is reserved for defaulting a sequence generator's 'sequence name'."},
                                           ...
                                           { "7211", "Mapping metadata cannot be applied to fields or properties that are transient, static or abstract. The attribute [{0}] from class [{1}] is in violation of this restriction. Ensure there are no mapping annotations defined on this attribute and ensure this attribute has not be defined as a persistence mapping within an XML file." },
                                           ...
                                           { "7218", "[{0}] does not override getCreateTempTableSqlPrefix method. Database platform that support temporary tables must override this method."},
                                           { "7219", "[{0}] does not override valueFromRowInternalWithJoin method, but it's isJoiningSupported method returns true. Foreign reference mapping that supports joining must override this method."},
                                           ...
                                           { "7263", "Class [{0}] has an incomplete optimistic locking specification. For an optimistic locking policy of type SELECTED_COLUMNS, the selected columns must be specified and the names of those columns can not be omitted."},
                                           ...
                                           { "7266", "The @Cache annotation on class [{0}] has both expiry() and expiryTimeToLive() specified. Only one of the two may be specified in a @Cache annotation setting."},
                                           ...
                                           { "7270", "The specified cache statments size value [{0}] is invalid [{1}]."},
                                           ...
                                           { "7275", "Unable instantiate the exception handler class [{0}] specified in the property eclipselink.exception-handler [{1}]."},
                                           { "7276", "Unable instantiate the session event listener class [{0}] specified in the property eclipselink.session-event-listener [{1}]."},
                                           { "7277", "The name of the logging file was not specified."},
                                           { "7278", "The specified boolean value [{0}] for for the persistence property [{1}] is invalid, the value must either be ''true'' or ''false''."},
                                           ...
                                           { "7293", "The write transformer specified for the elment [{0}] either does not have a column or the column does not have name."},
