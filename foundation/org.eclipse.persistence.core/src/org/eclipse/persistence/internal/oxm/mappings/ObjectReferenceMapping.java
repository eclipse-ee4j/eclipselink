...
public interface ObjectReferenceMapping<
    ...
    UNMARSHAL_RECORD extends UnmarshalRecord> extends Mapping<ATTRIBUTE_ACCESSOR, CONTAINER_POLICY, DESCRIPTOR, FIELD> {

    public Object buildFieldValue(Object targetObject, XMLField xmlField, ABSTRACT_SESSION session);

    public void buildReference(UNMARSHAL_RECORD unmarshalRecord, XMLField xmlField, Object realValue, ABSTRACT_SESSION session);
