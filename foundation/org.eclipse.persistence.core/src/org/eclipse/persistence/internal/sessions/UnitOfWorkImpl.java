        ...
        try {
            ...
            if (registeredObject == null) {
                ...
                if (descriptor.shouldLockForClone()|| !isFromSharedCache || (descriptor.isProtectedIsolation() && !(objectToRegister instanceof PersistenceEntity))){
                    //this code will return to the shared cache and clone the entity.  If there is no requirement to lock for clone and the cacheKey for the protected entity
                    // is cached on the original then do not enter this code.
