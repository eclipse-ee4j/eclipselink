...
public class MyTestTypeImpl extends SDODataObject implements MyTestType {
   ...
   public static final int END_PROPERTY_INDEX = START_PROPERTY_INDEX + 48;
   ...
   public commonj.sdo.DataObject getMyAnyTypeTest3() {
      return (commonj.sdo.DataObject)get(START_PROPERTY_INDEX + 4);
   }
   ...
   public byte[] getMyBase64BinaryTest() {
      return (byte[])get(START_PROPERTY_INDEX + 6);
   }
   ...
   public boolean getMyBooleanTest() {
      return getBoolean(START_PROPERTY_INDEX + 7);
   }
   ...
   public byte getMyByteTest() {
      return getByte(START_PROPERTY_INDEX + 8);
   }
   ...
   public double getMyDoubleTest() {
      return getDouble(START_PROPERTY_INDEX + 12);
   }
   ...
   public float getMyFloatTest() {
      return getFloat(START_PROPERTY_INDEX + 16);
   }
   ...
   public byte[] getMyHexBinaryTest() {
      return (byte[])get(START_PROPERTY_INDEX + 22);
   }
   ...
   public int getMyIntTest() {
      return getInt(START_PROPERTY_INDEX + 26);
   }
   ...
   public java.math.BigInteger getMyIntegerTest() {
      return getBigInteger(START_PROPERTY_INDEX + 27);
   }
   ...
   public long getMyLongTest() {
      return getLong(START_PROPERTY_INDEX + 29);
   }
   ...
   public java.math.BigInteger getMyNegativeIntegerTest() {
      return getBigInteger(START_PROPERTY_INDEX + 32);
   }
   ...
   public java.lang.String getMyNMTOKENTest() {
      return getString(START_PROPERTY_INDEX + 34);
   }
   ...
   public java.math.BigInteger getMyPositiveIntegerTest() {
      return getBigInteger(START_PROPERTY_INDEX + 38);
   }
   ...
   public short getMyShort() {
      return getShort(START_PROPERTY_INDEX + 41);
   }
   ...
   public short getMyUnsignedByteTest() {
      return getShort(START_PROPERTY_INDEX + 45);
   }
   ...
   public long getMyUnsignedIntTest() {
      return getLong(START_PROPERTY_INDEX + 46);
   }
   ...
   public java.math.BigInteger getMyUnsignedLongTest() {
      return getBigInteger(START_PROPERTY_INDEX + 47);
   }
   ...
   public int getMyUnsignedShortTest() {
      return getInt(START_PROPERTY_INDEX + 48);
   }
