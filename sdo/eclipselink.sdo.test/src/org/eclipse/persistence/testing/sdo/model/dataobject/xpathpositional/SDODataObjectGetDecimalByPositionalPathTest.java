...
public class SDODataObjectGetDecimalByPositionalPathTest extends SDODataObjectGetByPositionalPathTestCases {
    ...
    public static void main(String[] args) {
        String[] arguments = { "-c", "org.eclipse.persistence.testing.sdo.model.dataobject.xpathpositional.SDODataObjectGetDecimalByPositionalPathTest" };
    ...
    public void testGetDecimalFromBoolean() {
        ...
        try {
            ...
            BigDecimal controlValue = new BigDecimal(0);
