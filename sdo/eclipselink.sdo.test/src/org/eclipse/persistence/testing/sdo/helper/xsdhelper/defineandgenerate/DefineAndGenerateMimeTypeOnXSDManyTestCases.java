 ...
 ******************************************************************************/  
/* $Header: DefineAndGenerateMimeTypeOnXSDManyTestCases.java 23-nov-2006.14:26:34 dmahar Exp $ */
/*
   DESCRIPTION
 ...
 */
/**
 *  @version $Header: DefineAndGenerateMimeTypeOnXSDManyTestCases.java 23-nov-2006.14:26:34 dmahar Exp $
 *  @author  mfobrien
 *  @since   11.1
 */
...
public class DefineAndGenerateMimeTypeOnXSDManyTestCases extends XSDHelperDefineAndGenerateTestCases {
    public static void main(String[] args) {
        String[] arguments = { "-c", "org.eclipse.persistence.testing.sdo.helper.xsdhelper.defineandgenerate.DefineAndGenerateMimeTypeOnXSDManyTestCases" };
        TestRunner.main(arguments);
    }

    public DefineAndGenerateMimeTypeOnXSDManyTestCases(String name) {
        super(name);
    }
