...
public class ChangeSummaryXSDWithCSonChildDeleteChainToComplexSingleBelowRootTest extends ChangeSummaryOnChildTestCases {
    ...
    public ChangeSummaryXSDWithCSonChildDeleteChainToComplexSingleBelowRootTest(String name) {
        super(name);
    }

    public static void main(String[] args) {
        String[] arguments = { "-c", "org.eclipse.persistence.testing.sdo.model.changesummary.ChangeSummaryXSDWithCSonChildDeleteChainToComplexSingleBelowRootTest" };
