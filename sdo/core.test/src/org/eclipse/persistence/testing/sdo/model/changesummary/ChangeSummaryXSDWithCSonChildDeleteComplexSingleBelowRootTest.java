...
public class ChangeSummaryXSDWithCSonChildDeleteComplexSingleBelowRootTest extends ChangeSummaryOnChildTestCases {
    ...
    public ChangeSummaryXSDWithCSonChildDeleteComplexSingleBelowRootTest(String name) {
        super(name);
    }

    public static void main(String[] args) {
        String[] arguments = { "-c", "org.eclipse.persistence.testing.sdo.model.changesummary.ChangeSummaryXSDWithCSonChildDeleteComplexSingleBelowRootTest" };
