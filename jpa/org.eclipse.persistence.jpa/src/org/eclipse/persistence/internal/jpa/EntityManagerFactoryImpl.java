...
public class EntityManagerFactoryImpl implements EntityManagerFactory {
    ...
    protected void initializeCanonicalMetamodel(Metamodel model) {
        ...
        for (ManagedType manType : model.getManagedTypes()) {
            ...
            String className = MetadataHelper.getQualifiedCanonicalName(manType.getJavaType().getName(), getServerSession());
            try {
                
                Class clazz = (Class)getServerSession().getDatasourcePlatform().convertObject(className, ClassConstants.CLASS);
                classInitialized=true;
                getServerSession().log(SessionLog.FINER, SessionLog.METAMODEL, "metamodel_canonical_model_class_found", className);                
                String fieldName = "";
