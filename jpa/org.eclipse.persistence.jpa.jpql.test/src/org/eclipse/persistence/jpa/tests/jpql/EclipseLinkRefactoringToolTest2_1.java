...
import org.eclipse.persistence.jpa.jpql.EclipseLinkRefactoringTool;
 ...
 * RefactoringTool RefactoringTool} when the JPA version is 2.0 and EclipseLink version is 2.1 or
 * later.
 *
 * @version 2.4
 * @since 2.4
...
public final class EclipseLinkRefactoringToolTest2_1 extends AbstractRefactoringToolTest {

	private RefactoringTool buildRefactoringTool(String jpqlQuery) throws Exception {
		return new EclipseLinkRefactoringTool(
			getPersistenceUnit(),
			getJPQLQueryBuilder(),
			jpqlQuery
		);
