...
//		);
	...
	public void test_ConstructorExpression_MismatchedParameterTypes_1() throws Exception {
		...
		int startPosition = "SELECT NEW java.lang.StringBuilder(".length();
		int endPosition   = "SELECT NEW java.lang.StringBuilder(e.dept".length();
...
//		);
	...
	List<JPQLQueryProblem> validate(JPQLQueryHelper queryHelper) {
		return queryHelper.validateSemantic();
	}
}