...
final class JavaTypeRepository implements ITypeRepository {
	...
	private JavaType buildType(Class<?> javaType) {
		JavaType type = new JavaType(this, javaType);
		types.put(javaType.getName(), type);
		return type;
	}

	private JavaType buildType(String typeName) {
	...
	private JavaType loadArrayType(String typeName) {
	...
	private JavaType loadInnerType(String typeName) {
	...
	private JavaType loadTypeImp(String typeName) {
