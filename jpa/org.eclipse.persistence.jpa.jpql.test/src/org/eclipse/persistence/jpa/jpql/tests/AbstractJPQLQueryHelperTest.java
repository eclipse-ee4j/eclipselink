...
public abstract class AbstractJPQLQueryHelperTest extends AbstractJPQLQueryTest {

	/**
	 * Creates the concrete class of {@link JPQLQueryHelper}.
	 *
	 ...
	 */
	final JPQLQueryHelper buildQueryHelper(IQuery query) {
		return queryTestHelper().buildJPQLQueryHelper(query);
	}
