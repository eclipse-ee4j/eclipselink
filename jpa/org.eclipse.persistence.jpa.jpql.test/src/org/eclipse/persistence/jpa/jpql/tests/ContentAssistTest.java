...
public final class ContentAssistTest {
	...
	private static VirtualQuery virtualQuery;
	...
	public static void setUpBeforeClass() {
		...
		virtualQuery = new VirtualQuery(provider, null);
	}
	...
	private Iterable<String> abstractSchemaNames() {
	...
	private List<String> addAll(List<String> items1, Iterable<String> items2) {
	...
	private DefaultContentAssistProposals buildContentAssistProposals(String actualQuery,
	                                                                  int position) {
	...
	private IQuery buildQuery(String jpqlQuery) {
		virtualQuery.setExpression(jpqlQuery);
		return virtualQuery;
	}

	private Iterable<String> filter(Iterable<String> proposals, String startsWith) {
	...
	private Iterable<String> joinIdentifiers() {
	...
	private Iterable<String> joinOnlyIdentifiers() {
		List<String> proposals = new ArrayList<String>();
		proposals.add(INNER_JOIN);
		proposals.add(JOIN);
		proposals.add(LEFT_JOIN);
	...
	public void test_AbstractSchemaName_01() throws Exception {
		...
		testHasOnlyTheseProposals(query, position, abstractSchemaNames());
	}
	...
	public void test_AbstractSchemaName_02() throws Exception {
		...
		testHasOnlyTheseProposals(query, position, filter(abstractSchemaNames(), "E"));
	}
	...
	public void test_AbstractSchemaName_06() {
		...
		List<String> proposals = new ArrayList<String>();
		proposals.add(IN);
		addAll(proposals, abstractSchemaNames());
	...
	public void test_AbstractSchemaName_08() {
		String query = "SELECT e FROM Employee e ";
		int position = query.length();
		testDoesNotHaveTheseProposals(query, position, abstractSchemaNames());
	}
	...
	public void test_AbstractSchemaName_10() {
		String query = "SELECT e FROM Employee e ";
		int position = "SELECT e FROM ".length();
		testHasTheseProposals(query, position, abstractSchemaNames());
	}
	...
	public void test_AbstractSchemaName_11() {
		String query = "SELECT e FROM Employee e ";
		int position = "SELECT e FROM E".length();
		testHasTheseProposals(query, position, filter(abstractSchemaNames(), "f"));
	}
	...
	public void test_AbstractSchemaName_12() {
		...
		testHasOnlyTheseProposals(query, position, filter(abstractSchemaNames(), "Employee"));
	}
	...
	public void test_AbstractSchemaName_14() {
		...
		testHasOnlyTheseProposals(query, position, filter(abstractSchemaNames(), "A"));
	}
	...
	public void test_AvgFunction_05() {
		...
		addAll(proposals, JPQLQueryBNFAccessor.scalarExpressionFunctions());
	...
	public void test_AvgFunction_15() {
		...
		List<String> proposals = new ArrayList<String>();
		proposals.add("e");
		addAll(proposals, filter(JPQLQueryBNFAccessor.scalarExpressionFunctions(), "e"));
	...
	public void test_CollectionMemberDeclaration_14() {
		...
		List<String> proposals = new ArrayList<String>();
		proposals.add("e");
		addAll(proposals, JPQLQueryBNFAccessor.collectionMemberDeclarationParameters());
	...
	public void test_Constructor_06() throws Exception {
		...
		List<String> proposals = new ArrayList<String>();
		proposals.add("e");
		addAll(proposals, JPQLQueryBNFAccessor.constructorItemFunctions());
	...
	public void test_Constructor_13() {
		...
		List<String> proposals = new ArrayList<String>();
		proposals.add("c");
		addAll(proposals, filter(JPQLQueryBNFAccessor.constructorItemFunctions(), "c"));
	...
	public void test_CountFunction_17() {
		...
		proposals.add("emp");
		proposals.add(DISTINCT);
		addAll(proposals, JPQLQueryBNFAccessor.countFunctions());
	...
	public void test_Delete_26() {
		...
		int position = query.length();
		testHasOnlyTheseProposals(query, position, filter(abstractSchemaNames(), "P"));
	}
	...
	public void test_Restriction_02() throws Exception {
		String query = "SELECT AVG(e.name) FROM Employee e";
		int position = "SELECT AVG(e".length();
		testDoesNotHaveTheseProposals(query, position, JPQLQueryBNFAccessor.selectItemIdentifiers());
	}
	...
	public void test_Select_01() throws Exception {
		...
		List<String> proposals = new ArrayList<String>();
		proposals.add(DISTINCT);
		addAll(proposals, JPQLQueryBNFAccessor.selectItemFunctions());
	...
	public void test_Select_05() throws Exception {
		String query = "SELECT e,";
		int position = query.length();
		testHasOnlyTheseProposals(query, position, JPQLQueryBNFAccessor.selectItemFunctions());
	}
	...
	public void test_SelectItem_02() {
		...
		int position = "SELECT O".length();
		testHasOnlyTheseProposals(query, position, filter(JPQLQueryBNFAccessor.selectItemIdentifiers(), "O"));
	}
	...
	public void test_SubQuery_01() throws Exception {
		...
		List<String> proposals = new ArrayList<String>();
		proposals.add("e");
		addAll(proposals, JPQLQueryBNFAccessor.comparisonExpressionFunctions());
		addAll(proposals, JPQLQueryBNFAccessor.comparisonExpressionClauses());
	...
	public void test_SubQuery_10() throws Exception {
		...
		proposals.add(AS);
		proposals.add(FROM);
		addAll(proposals, JPQLQueryBNFAccessor.selectItemAggregates());
	...
	public void test_Update_18() {
		...
		int position = query.length();
		testHasOnlyTheseProposals(query, position, filter(abstractSchemaNames(), "S"));
	}
	...
	private void testDoesNotHaveTheseProposals(String query, int position, Enum<?>... proposals) {
		testDoesNotHaveTheseProposals(query, position, toString(proposals));
	}

	private void testDoesNotHaveTheseProposals(String query, int position, Iterable<String> proposals) {
	...
	private void testDoesNotHaveTheseProposals(String query, int position, String... proposals) {
		testDoesNotHaveTheseProposals(query, position, Arrays.asList(proposals));
	}

	private void testHasNoProposals(String query, int position) {
	...
	private void testHasOnlyTheseProposals(String query, int position, Enum<?>... proposals) {
		testHasOnlyTheseProposals(query, position, toString(proposals));
	}

	private void testHasOnlyTheseProposals(String query, int position, Iterable<String> proposals) {
	...
	private void testHasOnlyTheseProposals(String query, int position, String... proposals) {
		testHasOnlyTheseProposals(query, position, Arrays.asList(proposals));
	}

	private void testHasTheseProposals(String query, int position, Enum<?>... enums) {
		testHasTheseProposals(query, position, toString(enums));
	}

	private void testHasTheseProposals(String query, int position, Iterable<String> proposals) {
	...
	private void testHasTheseProposals(String query, int position, String... proposals) {
