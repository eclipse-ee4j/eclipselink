...
@Entity
public class ConvertEntityBW2S {
    @Id
    private long id;
    ...
    public ConvertEntityBW2S() {
        
    }
    
    public ConvertEntityBW2S(long id) {
        this.id = id;
    }
    
    public ConvertEntityBW2S(long id, Boolean valueConvert, Boolean valueNoConvert) {
        this.id = id;
    ...
    public String toString() {
        return "ConvertEntityBW2S [id=" + id + ", valueConvert=" + valueConvert + ", valueNoConvert=" + valueNoConvert + "]";
    }
