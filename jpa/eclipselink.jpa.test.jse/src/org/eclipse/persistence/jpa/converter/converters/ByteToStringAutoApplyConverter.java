...
public class ByteToStringAutoApplyConverter implements AttributeConverter<Byte, String> {
    public static boolean convertToDatabaseTriggered = false;
    public static boolean convertToEntityTriggered = false;
    
    public static Byte ctdcVal = null;
    ...
    public String convertToDatabaseColumn(Byte attribute) {
        ...
        ctdcVal = attribute;
        return Byte.toString(attribute);
    }
