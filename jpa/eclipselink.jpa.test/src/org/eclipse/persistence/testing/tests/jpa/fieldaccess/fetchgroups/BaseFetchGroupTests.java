...
public abstract class BaseFetchGroupTests extends JUnitTestCase {
    ...
    private void reprepareReadQueriesInternal(ClassDescriptor descriptor, boolean shouldClear) {
        ...
        AbstractSession session = getServerSession("fieldaccess");
    ...
    public static void assertFetchedAttribute(Object entity, String... attribute) {
        FetchGroupAssert.assertFetchedAttribute(getEntityManagerFactory("fieldaccess"), entity, attribute);
    }

    public static void assertNotFetchedAttribute(Object entity, String... attribute) {
        FetchGroupAssert.assertNotFetchedAttribute(getEntityManagerFactory("fieldaccess"), entity, attribute);
    }
    ...
    ClassDescriptor getDescriptor(String entityName) {
        return getServerSession("fieldaccess").getClassDescriptorForAlias(entityName);
    }
