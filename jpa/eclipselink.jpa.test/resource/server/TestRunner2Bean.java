 ...
 * @author mschinca
 */
@Stateless(name="TestRunner2", mappedName="TestRunner2")
@Remote(TestRunner2.class)
@TransactionManagement(TransactionManagementType.BEAN)
public class TestRunner2Bean implements TestRunner2 {
    ...
    @PersistenceUnit(unitName="MulitPU-2")
