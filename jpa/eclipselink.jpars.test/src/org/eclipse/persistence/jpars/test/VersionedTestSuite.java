...
import org.eclipse.persistence.jpars.test.server.ServerPagingTest;
...
public class VersionedTestSuite extends Suite {
    private static String[] v2TestClasses = { ServerEmployeeTestV2.class.getName(), ServerPagingTest.class.getName() };
