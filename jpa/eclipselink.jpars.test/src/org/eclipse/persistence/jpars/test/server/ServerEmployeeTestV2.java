...
public class ServerEmployeeTestV2 {
    ...
    private void executeMultiResultQueryCount(MediaType mediaType) throws Exception {
        ...
        if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
            assertTrue(queryResult.equals("{\"items\":[{\"COUNT\":2}],\"links\":[{\"_link\":{\"href\":\"" + RestUtils.getServerURI() + DEFAULT_PU +
    ...
    private void executeQueryGetAll(MediaType mediaType) throws Exception {
        ...
        if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
            expected0 = "{\"items\":[{";
            expected1 = "{\"city\":\"Newyork City\",\"country\":\"USA\",\"id\":" + address1.getId() + ",\"postalCode\":\"10005\",\"province\":\"NY\",\"street\":\"Wall Street\",\"_relationships\":[],\"links\":[{\"_link\":{\"href\":\"" +
                    RestUtils.getServerURI() + DEFAULT_PU + "/entity/EmployeeAddress/" + address1.getId() + "\",\"rel\":\"self\"}}]}";
            expected2 = "{\"city\":\"Ottawa\",\"country\":\"Canada\",\"id\":" +
                    address2.getId() + ",\"postalCode\":\"K1Y 6F7\",\"province\":\"Ontario\",\"street\":\"Main Street\",\"_relationships\":[],\"links\":[{\"_link\":{\"href\":\"" +
                    RestUtils.getServerURI() + DEFAULT_PU + "/entity/EmployeeAddress/" + address2.getId() + "\",\"rel\":\"self\"}}]}],\"";
            expected3 = "links\":[{\"_link\":{\"href\":\"" + RestUtils.getServerURI() + DEFAULT_PU + "/query/EmployeeAddress.getAll\",\"rel\":\"self\"}}]}";
        } else if (mediaType == MediaType.APPLICATION_XML_TYPE) {
            expected0 = "<items>";
            expected1 = "<items><city>Newyork City</city><country>USA</country><id>" + address1.getId() +
                    "</id><postalCode>10005</postalCode><province>NY</province><street>Wall Street</street><links><_link href=\"" +
                    RestUtils.getServerURI() + DEFAULT_PU + "/entity/EmployeeAddress/" + address1.getId() + "\" rel=\"self\"/>";
            expected2 = "<items><city>Ottawa</city><country>Canada</country><id>" + address2.getId() +
                    "</id><postalCode>K1Y 6F7</postalCode><province>Ontario</province><street>Main Street</street><links><_link href=\"" +
                    RestUtils.getServerURI() + DEFAULT_PU + "/entity/EmployeeAddress/" + address2.getId() + "\" rel=\"self\"/>";
            expected3 = "<links><_link href=\"" + RestUtils.getServerURI() + DEFAULT_PU + "/query/EmployeeAddress.getAll\" rel=\"self\"/>";
        } else {
            // unsupported media type
    ...
    private void executeMultiResultQueryGetEmployeeAddressWithSimpleFields(MediaType mediaType) throws Exception {
        ...
        if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
            ...
            assertTrue(result.contains("\"links\":[{\"_link\":{\"href\":\"http://localhost:8080/eclipselink.jpars.test/persistence/v2.0/jpars_employee-static/query/EmployeeAddress.getRegion\",\"rel\":\"self\"}}]"));
        } else if (mediaType == MediaType.APPLICATION_XML_TYPE) {
            ...
            assertTrue(result.contains("<links><_link href=\"" + RestUtils.getServerURI() + DEFAULT_PU + "/query/EmployeeAddress.getRegion\" rel=\"self\"/></links></items>"));
        } else {
            // unsupported media type
            throw new RestCallFailedException(Status.BAD_REQUEST);
        }
    ...
    private void executeSingleResultQuery(MediaType mediaType) throws Exception {
        ...
        if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
            expected = "{\"areaPicture\":\"\","
                    + "\"city\":\"Newyork City\",\"country\":\"USA\",\"id\":" + address.getId() +
                    ",\"postalCode\":\"10005\",\"province\":\"NY\",\"street\":\"Wall Street\",\"_relationships\":[],\"links\":[{\"_link\":{\"href\":\"" +
                    RestUtils.getServerURI() + DEFAULT_PU + "/entity/EmployeeAddress/" + address.getId() + "\",\"rel\":\"self\"}}]";
        } else if (mediaType == MediaType.APPLICATION_XML_TYPE) {
            expected = "<areaPicture></areaPicture>"
                    +
                    "<city>Newyork City</city><country>USA</country><id>" +
                    address.getId() +
                    "</id><postalCode>10005</postalCode><province>NY</province><street>Wall Street</street><links><_link href=\"" +
    ...
    private void getEmployeeAddressMultiResultNamedQueryWithBinaryData(MediaType mediaType) throws Exception {
        ...
        String expected = null;
        if (mediaType == MediaType.APPLICATION_XML_TYPE) {
            expected = "<items><item><areaPicture></areaPicture></item><links><_link href=\""
                    + RestUtils.getServerURI() + DEFAULT_PU + "/query/EmployeeAddress.getPicture;id=" + address.getId() +
                    "\" rel=\"self\"/></links></items>";
        } else if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
    ...
    private void readEmployeeResponsibilities(MediaType mediaType) throws Exception {
        ...
        if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
            String expected = "{\"items\":[\"musician\",\"architect\",\"conductor\"],\"links\":[{\"_link\":{\"href\":\"" + RestUtils.getServerURI() + DEFAULT_PU + "/entity/Employee/" +
                    employee.getId() + "/responsibilities\",\"rel\":\"self\"}}]}";
            assertTrue(result.contains(expected));
        } else if (mediaType == MediaType.APPLICATION_XML_TYPE) {
