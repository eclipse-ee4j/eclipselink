...
public class ServerEmployeeTestV2 {
    ...
    public void testCreateEmployeeWithAddressJSON() throws Exception {
        ...
        String addressLink = "\"address\":{\"_link\":{\"href\":\"" + RestUtils.getServerURI() + DEFAULT_PU + "/entity/EmployeeAddress/201404\",\"method\":\"GET\",\"rel\":\"self\"}";
    ...
    /**
     * Test database exception json.
     *
     * @throws Exception the exception
     */
    @Test
    public void testDatabaseExceptionJSON() throws Exception {
        databaseException(MediaType.APPLICATION_JSON_TYPE);
    }

    /**
     * Test database exception xml.
     *
     * @throws Exception the exception
     */
    @Test
    public void testDatabaseExceptionXML() throws Exception {
        databaseException(MediaType.APPLICATION_XML_TYPE);
    }
    ...
    private void executeMultiResultQueryMax(MediaType mediaType) throws Exception {
        ...
        if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
            ...
            assertTrue(queryResult.contains("<result><items>"));
    ...
    private void executeMultiResultQueryCount(MediaType mediaType) throws Exception {
        ...
        if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
            assertTrue(queryResult.equals("{\"items\":[{\"COUNT\":2}],\"links\":[{\"href\":\"" +
                    RestUtils.getServerURI() + DEFAULT_PU +
                    "/query/Employee.count\",\"rel\":\"self\"}]}"));
        } else if (mediaType == MediaType.APPLICATION_XML_TYPE) {
            assertTrue(queryResult.contains("<?xml version=\"1.0\" encoding=\"UTF-8\"?><result><items><item><COUNT>2</COUNT></item></items><links><link><href>" +
                    RestUtils.getServerURI() + DEFAULT_PU +
                    "/query/Employee.count</href><rel>self</rel></link></links></result>"));
        } else {
            // unsupported media type
            throw new RestCallFailedException(Status.BAD_REQUEST);
        }
    ...
    private void executeQueryGetAll(MediaType mediaType) throws Exception {
        ...
        if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
            String expected0 = "{\"items\":[{\"type\":\"employeeAddress\",\"city\":\"Newyork City\",\"country\":\"USA\",\"id\":" +
                    address1.getId() +
                    ",\"postalCode\":\"10005\",\"province\":\"NY\",\"street\":\"Wall Street\",\"_relationships\":[],\"links\":[{\"href\":\"" +
                    RestUtils.getServerURI() + DEFAULT_PU +
                    "/entity/EmployeeAddress/" +
                    address1.getId() +
                    "\",\"rel\":\"self\"}]},{\"type\":\"employeeAddress\",\"city\":\"Ottawa\",\"country\":\"Canada\",\"id\":" +
                    address2.getId() +
                    ",\"postalCode\":\"K1Y 6F7\",\"province\":\"Ontario\",\"street\":\"Main Street\",\"_relationships\":[],\"links\":[{\"href\":\"" +
                    RestUtils.getServerURI() + DEFAULT_PU +
                    "/entity/EmployeeAddress/" +
                    address2.getId() +
                    "\",\"rel\":\"self\"}]}],\"links\":[{\"href\":\"" +
                    RestUtils.getServerURI() + DEFAULT_PU +
                    "/query/EmployeeAddress.getAll\",\"rel\":\"self\"}]}";
            assertTrue(result.contains(expected0));
        } else if (mediaType == MediaType.APPLICATION_XML_TYPE) {
            String expected0 = "<result>";
            String expected1 = "<items>";

            // TODO: Fix expected result (suppressing xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance) 
            // after Bug https://bugs.eclipse.org/bugs/show_bug.cgi?id=410375 is fixed. 

            String expected2 = "<city>Newyork City</city><country>USA</country><id>" + address1.getId() + "</id>" +
                    "<postalCode>10005</postalCode><province>NY</province><street>Wall Street</street>" +
                    "<links><link><href>" + RestUtils.getServerURI() + DEFAULT_PU + "/entity/EmployeeAddress/" + address1.getId() +
                    "</href><rel>self</rel></link></links></item>";

            String expected3 = "<city>Ottawa</city><country>Canada</country><id>" + address2.getId() + "</id>" +
                    "<postalCode>K1Y 6F7</postalCode><province>Ontario</province><street>Main Street</street>" +
                    "<links><link><href>" + RestUtils.getServerURI() + DEFAULT_PU + "/entity/EmployeeAddress/" + address2.getId() +
                    "</href><rel>self</rel></link></links></item>";

            String expected4 = "<links><link><href>" +
                    RestUtils.getServerURI() + DEFAULT_PU +
                    "/query/EmployeeAddress.getAll</href><rel>self</rel></link></links>";
    ...
    private void executeMultiResultQueryGetEmployeeAddressWithSimpleFields(MediaType mediaType) throws Exception {
        ...
        if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
            ...
            assertTrue(result.contains("\"links\":[{\"href\":\"" +
                    RestUtils.getServerURI() + DEFAULT_PU +
                    "/query/EmployeeAddress.getRegion\",\"rel\":\"self\"}]"));
        } else if (mediaType == MediaType.APPLICATION_XML_TYPE) {
            assertTrue(result.contains("<items><item>"));
            ...
            assertTrue(result.contains("<links><link><href>" +
                    RestUtils.getServerURI() + DEFAULT_PU +
                    "/query/EmployeeAddress.getRegion</href><rel>self</rel></link></links>"));
        } else {
            // unsupported media type
            throw new RestCallFailedException(Status.BAD_REQUEST);
        }
    ...
    private void executeSingleResultQuery(MediaType mediaType) throws Exception {
        ...
        if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
            expected = "{\"areaPicture\":\"\","
                    ...
                    "\"links\":[{\"href\":\"" +
                    RestUtils.getServerURI() + DEFAULT_PU +
                    "/entity/EmployeeAddress/9112\",\"rel\":\"self\"}]}";
        } else if (mediaType == MediaType.APPLICATION_XML_TYPE) {
            expected = "<employeeAddress>"
                    +
                    "<areaPicture>"
                    +
                    ...
                    "<links>" +
                    "<link>" +
                    "<href>" + RestUtils.getServerURI() + DEFAULT_PU + "/entity/EmployeeAddress/9112" + "</href>" +
                    "<rel>self</rel>" +
                    "</link>" +
                    "</links>" +
                    "</employeeAddress>";
    ...
    private void getEmployeeAddressMultiResultNamedQueryWithBinaryData(MediaType mediaType) throws Exception {
        ...
        String expected = null;
        if (mediaType == MediaType.APPLICATION_XML_TYPE) {
            expected = "<result><items><item><areaPicture></areaPicture></item></items>"
                    +
                    "<links><link><href>" +
                    RestUtils.getServerURI() + DEFAULT_PU +
                    "/query/EmployeeAddress.getPicture;id=" +
                    address.getId() +
                    "</href><rel>self</rel></link></links></result>";
        } else if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
    ...
    private void readEmployeeResponsibilities(MediaType mediaType) throws Exception {
        ...
        // after Bug https://bugs.eclipse.org/bugs/show_bug.cgi?id=410375 is fixed. 
        if (mediaType == MediaType.APPLICATION_JSON_TYPE) {
            String expected = "{\"items\":[{\"type\":\"string\",\"value\":\"musician\"},{\"type\":\"string\",\"value\":\"architect\"},{\"type\":\"string\",\"value\":\"conductor\"}],\"links\":[{\"href\":\"" +
                    RestUtils.getServerURI() + DEFAULT_PU +
                    "/entity/Employee/" +
                    employee.getId() +
                    "/responsibilities\",\"rel\":\"self\"}]}";
            assertTrue(result.contains(expected));
        } else if (mediaType == MediaType.APPLICATION_XML_TYPE) {
            // TODO: Fix expected result (suppressing xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance) 
            // after Bug https://bugs.eclipse.org/bugs/show_bug.cgi?id=410375 is fixed. 
            String expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                    "<result>" +
                    "<items>" +
                    "<item xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:type=\"xsd:string\">musician" +
                    "</item>" +
                    "<item xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:type=\"xsd:string\">architect" +
                    "</item>" +
                    "<item xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:type=\"xsd:string\">conductor" +
                    "</item>" +
                    "</items>" +
                    "<links>" +
                    "<link>" +
    ...
    private void databaseException(MediaType mediaType) throws Exception {
        Employee employee = new Employee();
        employee.setId(19209);
        employee.setFirstName("Pat");
        employee.setLastName("Metheny");
        EmploymentPeriod employmentPeriod = new EmploymentPeriod();
        employmentPeriod.setStartDate(GregorianCalendar.getInstance());
        ...
        Employee employeeCreated = (Employee) RestUtils.restCreate(context, employee, Employee.class.getSimpleName(), Employee.class, null, mediaType, true);
        assertNotNull("Employee create failed.", employeeCreated);

        // 2nd create call should fail, because of the violation of the integrity constraints
        try {
            employeeCreated = (Employee) RestUtils.restCreate(context, employee, Employee.class.getSimpleName(), Employee.class, null, mediaType, true);
        } catch (RestCallFailedException ex) {
            ErrorResponse errorResponse = ex.getErrorDetails();
            assertNotNull(errorResponse);
            assertTrue(DatabaseException.class.getName().equals(errorResponse.getTitle()));
        } finally {
            RestUtils.restDelete(context, employee.getId(), Employee.class.getSimpleName(), Employee.class, null, null, mediaType);
        }
    }
