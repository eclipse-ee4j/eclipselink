...
public interface IdentifiableType<X> extends ManagedType<X> {
     ...
     *             if id attribute of the given name and type is not present in
     ...
     * @throws IllegalArgumentException
     *             if version attribute of the given name and type is not
     *             present in the identifiable type
     */
    ...
    /**
     * Whether or not the identifiable type has an id attribute. Returns true
     * for a simple id or embedded id; returns false for an idclass.
     * 
     * @return boolean indicating whether or not the identifiable type has an id
     *         attribute
     */
