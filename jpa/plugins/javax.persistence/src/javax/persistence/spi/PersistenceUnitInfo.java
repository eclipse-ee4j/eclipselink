...
public interface PersistenceUnitInfo {
	 ...
	 * element in the persistence.xml file or is provided at deployment or by
	 * the container.
	 * 
	 ...
	 * provider for accessing data outside a JTA transaction. The data source
	 * corresponds to the named &lt;non-jta-data-source&gt; element in the
	 * persistence.xml file or provided at deployment or by the container.
	 * 
	 ...
	 * must be in the standard XML mapping format, be uniquely named and be
	 * resource-loadable from the application classpath. This list will not
	 * include the orm.xml file if one was specified. Each mapping file name
	 * corresponds to a &lt;mapping-file&gt; element in the persistence.xml
	 * file.
	 * 
	 ...
	 * persistence unit. Each URL corresponds to a named <jar-file> element in
	 * the persistence.xml file. A URL will either be a file: URL referring to a
	 * jar file or referring to a directory that contains an exploded jar file,
	 * or some other URL from which an InputStream in jar format can be
	 * obtained.
	 * 
	 ...
	 * provider must add it to its set of managed classes. Each name corresponds
	 * to a named &lt;class&gt; element in the persistence.xml file.
	 * 
	 ...
	 * This value corresponds to the &lt;exclude-unlisted-classes&gt; element in
	...
	/**
	 * Returns properties object. Each property corresponds to a
	 ...
	 * returned by the {@link PersistenceUnitInfo#getClassLoader} method. The
	 ...
	 * returned by {@link PersistenceUnitInfo#getClassLoader}. None of the
	 * classes loaded by this class loader will be visible to application
	 * components. The provider may only use this ClassLoader within the scope
