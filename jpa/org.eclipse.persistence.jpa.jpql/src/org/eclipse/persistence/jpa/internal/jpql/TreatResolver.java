...
public final class TreatResolver extends Resolver {
	 ...
	 */
	TreatResolver(Resolver parent, String entityTypeName) {
		super(parent);
	...
	ITypeDeclaration buildTypeDeclaration() {
		IManagedType managedType = getProvider().getManagedType(entityTypeName);
		if (managedType != null) {
