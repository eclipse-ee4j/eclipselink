 ...
 */
public final class DeclarationExpressionLocator extends AbstractTraverseParentVisitor {
	 ...
	 */
	public DeclarationExpressionLocator() {
		this(true);
	}
	 ...
	 */
	public DeclarationExpressionLocator(boolean traverseParentQueries) {
		super();
	 ...
	 */
	public Set<Expression> declarationExpresions() {
		return expressions;
	}
