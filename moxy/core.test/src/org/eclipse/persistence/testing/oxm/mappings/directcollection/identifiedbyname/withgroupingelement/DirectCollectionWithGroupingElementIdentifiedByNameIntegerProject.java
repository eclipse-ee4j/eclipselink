...
public class DirectCollectionWithGroupingElementIdentifiedByNameIntegerProject extends Project {
    public DirectCollectionWithGroupingElementIdentifiedByNameIntegerProject() {
