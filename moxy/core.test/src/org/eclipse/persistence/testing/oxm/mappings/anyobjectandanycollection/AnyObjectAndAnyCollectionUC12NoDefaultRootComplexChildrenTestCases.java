 ...
 */
public class AnyObjectAndAnyCollectionUC12NoDefaultRootComplexChildrenTestCases extends XMLMappingTestCases {
    public static final String XML_RESOURCE_PATH = "org/eclipse/persistence/testing/oxm/mappings/anyobjectandanycollection/Customer-data_uc12.xml";
    ...
    public AnyObjectAndAnyCollectionUC12NoDefaultRootComplexChildrenTestCases(String name) throws Exception {
        super(name);
