 ...
 ******************************************************************************/  
package org.eclipse.persistence.testing.oxm.mappings.onetoone.keyonsource.eis.compositekey;
...
public class CompositeKeyProject extends org.eclipse.persistence.sessions.Project {

  public CompositeKeyProject() {
    ...
    login.setProperty("directory", "./org/eclipse/persistence/testing/oxm/mappings/onetoone/keyonsource/eis/compositekey/");
    setLogin(login);
  }
  ...
  private EISDescriptor getEmployeeDescriptor() {
    ...
    XQueryInteraction projectInteraction = new XQueryInteraction();	
		...
		projectInteraction.setXQueryString("project[@id='#@project-id' and name/text()='#@project-name']");
		...
		projectMapping.addForeignKeyFieldName("@project-name", "name/text()");
