...
public class NoGroupingElementIndirectionArrayListProject extends org.eclipse.persistence.sessions.Project {

  public NoGroupingElementIndirectionArrayListProject() {
    ...
    EISLogin login = new EISLogin(new XMLFilePlatform());
		...
		login.setProperty("directory", "./org/eclipse/persistence/testing/oxm/mappings/onetomany/keyonsource/eis/nogroupingelement/indirection/arraylist");
		setLogin(login);
  }
