...
public class OwnedToExternalRootProject extends org.eclipse.persistence.sessions.Project {
  ...
  public OwnedToExternalRootProject() {
    ...
    login.setProperty("directory", "./org/eclipse/persistence/testing/oxm/mappings/onetoone/keyontarget/eis/ownedtoexternalroot/");
    setLogin(login);
  }
  ...
  private EISDescriptor getEmployeeDescriptor() {
    ...
    descriptor.setPrimaryKeyFieldName("first-name");
 ...
 /*   
    ...
    XQueryInteraction leaderInteraction = new XQueryInteraction();	
		...
		leaderInteraction.setXQueryString("team/employee[first-name='#leader']"); 
