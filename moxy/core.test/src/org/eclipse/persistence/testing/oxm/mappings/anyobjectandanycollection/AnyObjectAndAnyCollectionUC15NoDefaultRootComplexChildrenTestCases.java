 ...
 */
public class AnyObjectAndAnyCollectionUC15NoDefaultRootComplexChildrenTestCases extends XMLMappingTestCases {
    public static final String XML_RESOURCE_PATH = "org/eclipse/persistence/testing/oxm/mappings/anyobjectandanycollection/Customer-data_uc15.xml";
    ...
    public AnyObjectAndAnyCollectionUC15NoDefaultRootComplexChildrenTestCases(String name) throws Exception {
        super(name);
