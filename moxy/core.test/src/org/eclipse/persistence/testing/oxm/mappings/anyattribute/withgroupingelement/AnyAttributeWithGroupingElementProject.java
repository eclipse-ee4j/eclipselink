...
/**
 *  @version $Header: AnyAttributeWithGroupingElementProject.java 02-nov-2006.10:56:47 gyorke Exp $
 *  @author  mmacivor
 *  @since   release specific (what release of product did this appear in)
 */

public class AnyAttributeWithGroupingElementProject extends Project {
    public AnyAttributeWithGroupingElementProject() {
    ...
    public ClassDescriptor buildRootDescriptor() {
        ...
        mapping.setXPath("grouping-element");
