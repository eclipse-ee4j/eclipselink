 ...
 */
public class AnyObjectAndAnyCollectionUC10NoDefaultRootComplexChildrenTestCases extends XMLMappingTestCases {
    public static final String XML_RESOURCE_PATH = "org/eclipse/persistence/testing/oxm/mappings/anyobjectandanycollection/Customer-data_uc10.xml";
    ...
    public AnyObjectAndAnyCollectionUC10NoDefaultRootComplexChildrenTestCases(String name) throws Exception {
        super(name);
    ...
    public Object getControlObject() {
        ...
        customer.setAnyObject(contactMethods);//anAddress1);
        return customer;
    }
