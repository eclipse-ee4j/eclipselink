...
public class ConflictingListClassesTestCases  extends TypeMappingInfoWithJSONTestCases{
	...
	public ConflictingListClassesTestCases(String name) throws Exception {
		super(name);
		init();
	}
