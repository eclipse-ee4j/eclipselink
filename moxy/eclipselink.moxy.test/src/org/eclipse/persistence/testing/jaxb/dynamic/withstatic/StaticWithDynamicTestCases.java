...
public class StaticWithDynamicTestCases extends JAXBWithJSONTestCases {
...
//    private DynamicJAXBContext jaxbContext;
    ...
    private static final String NO_ADDRESS = RESOURCE_DIR + "address-with-phone-oxm.xml";
    private static final String CONTROL_DOC = RESOURCE_DIR + "customer3.xml";
    private static final String JSON_CONTROL_DOC = RESOURCE_DIR + "customer3.json";
    private static final String PACKAGE = "org.eclipse.persistence.testing.jaxb.dynamic.withstatic";

    public StaticWithDynamicTestCases(String name) throws Exception {
        super(name);
        setupContext();
    ...
    void setupContext() throws Exception {
        ...
        if (iStream == null) {
            fail("Couldn't load metadata file [" + NO_ADDRESS + "]");
        }
    ...
    public void jsonToObjectTest(Object testObject) throws Exception {
        ...
        log("Actual:");
        log(testObject.toString());
        compareDynamicEntities(testObject, getReadControlObject());
    }
