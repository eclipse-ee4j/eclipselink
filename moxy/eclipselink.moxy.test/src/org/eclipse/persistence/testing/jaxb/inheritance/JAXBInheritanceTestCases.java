...
public class JAXBInheritanceTestCases extends JAXBTestCases {
	 public JAXBInheritanceTestCases(String name) throws Exception {
	    ...
	    setWriteControlDocument("org/eclipse/persistence/testing/jaxb/inheritance/inheritanceWrite.xml");
	 }
	 
	 public Object getControlObject() {
	     //reads a document that also contains a value for "ddd" and makes sure we ignore it 
		 E object = new E();		 
		 object.setAaa(1);
		 object.setBbb(2);
		 object.setCcc(3);
	 ...
	 public Object getWriteControlObject() {
		//writes a document that also contains a value for "ddd" and makes sure we ignore it
		 E object = new E();		 
		 object.setAaa(1);
		 object.setBbb(2);
		 object.setCcc(3);
