...
public class ExtendedList6TestCases extends JAXBWithJSONTestCases {
    ...
    public ExtendedList6TestCases(String name) throws Exception {
        super(name);
    ...
    @Override
    protected ExtendedList6Root getControlObject() {
        ExtendedList6Root control = new ExtendedList6Root();
        control.foo = new ExtendedList6<Foo>();
