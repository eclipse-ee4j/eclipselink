...
public class CollectionHolderWrappersNillableInitializedELTestCases extends JAXBWithJSONTestCases {
    ...
    private final static String JSON_RESOURCE = "org/eclipse/persistence/testing/jaxb/collections/emptycollectionholderwrappersnillableinitializedEL.json";

    public CollectionHolderWrappersNillableInitializedELTestCases(String name) throws Exception {
        super(name);
