...
public class SetHolderTestCases extends JAXBWithJSONTestCases {
    ...
    public SetHolderTestCases(String name) throws Exception {
        super(name);
    ...
    @Override
    protected SetHolder getControlObject() {
        SetHolder ch = new SetHolder();
        ...
        ch.getCollection5().add(new SetHolder());
