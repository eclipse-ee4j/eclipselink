...
public class NavigableSetHolder {
    ...
    protected NavigableSet<byte[]> collection11;
    ...
    public NavigableSet getCollection4() {
        return collection4;
    }
    public void setCollection4(NavigableSet collection4) {
    ...
    public void setCollection5(NavigableSet<NavigableSetHolder> collection5) {
     ...
     public NavigableSet getCollection6() {
        return collection6;
    }

    public void setCollection6(NavigableSet collection6) {
    ...
    public NavigableSet<byte[]> getCollection11() {
        return collection11;
    }

    public void setCollection11(NavigableSet<byte[]> collection11) {
