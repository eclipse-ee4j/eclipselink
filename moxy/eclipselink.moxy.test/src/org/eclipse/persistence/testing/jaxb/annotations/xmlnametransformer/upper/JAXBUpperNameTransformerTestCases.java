...
public class JAXBUpperNameTransformerTestCases extends JAXBWithJSONTestCases {
	...
	private final static String JSON_RESOURCE = "org/eclipse/persistence/testing/jaxb/annotations/xmlnametransformer/employeeUpper.json";
