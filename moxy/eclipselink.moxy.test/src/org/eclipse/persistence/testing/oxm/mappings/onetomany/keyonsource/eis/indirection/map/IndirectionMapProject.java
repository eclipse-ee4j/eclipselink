...
public class IndirectionMapProject extends org.eclipse.persistence.sessions.Project {

  public IndirectionMapProject() {
    ...
    EISLogin login = new EISLogin(new XMLFilePlatform());
		...
		login.setProperty("directory", "./org/eclipse/persistence/testing/oxm/mappings/onetomany/keyonsource/eis/indirection/map/");
		setLogin(login);
  }
