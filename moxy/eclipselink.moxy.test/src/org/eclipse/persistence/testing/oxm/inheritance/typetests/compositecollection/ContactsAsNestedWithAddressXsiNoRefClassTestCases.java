...
public class ContactsAsNestedWithAddressXsiNoRefClassTestCases extends ContactsAsNestedWithAddressXsiTestCases {
    public ContactsAsNestedWithAddressXsiNoRefClassTestCases(String name) throws Exception {
        super(name);
    ...
    public static void main(String[] args) {
        String[] arguments = { "-c", "org.eclipse.persistence.testing.oxm.inheritance.typetests.compositecollection.ContactsAsNestedWithAddressXsiNoRefClassTestCases" };
