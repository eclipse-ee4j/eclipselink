 ...
 */
public class AnyObjectAndAnyCollectionUC03NoDefaultRootComplexChildrenTestCases extends XMLMappingTestCases {
    public static final String XML_RESOURCE_PATH = "org/eclipse/persistence/testing/oxm/mappings/anyobjectandanycollection/Customer-data_uc03.xml";
    ...
    public AnyObjectAndAnyCollectionUC03NoDefaultRootComplexChildrenTestCases(String name) throws Exception {
        super(name);
