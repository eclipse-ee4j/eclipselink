...
import org.eclipse.persistence.testing.oxm.xmlmarshaller.structureValidation.sequence.nestedGroup.Employee.EmploymentInfo;

public class SequenceWithNestedGroupTestCases extends OXTestCase {
    ...
    public SequenceWithNestedGroupTestCases(String name) throws Exception {
        super(name);
    }
