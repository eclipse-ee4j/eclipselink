...
public class DirectCollectionWithoutGroupingElementIdentifiedByNameProject extends Project {
    public DirectCollectionWithoutGroupingElementIdentifiedByNameProject() {
