...
public class DirectToXMLElementIdentifiedByNameTestCases extends XMLMappingTestCases {
  ...
  public DirectToXMLElementIdentifiedByNameTestCases(String name) throws Exception {
    super(name);
