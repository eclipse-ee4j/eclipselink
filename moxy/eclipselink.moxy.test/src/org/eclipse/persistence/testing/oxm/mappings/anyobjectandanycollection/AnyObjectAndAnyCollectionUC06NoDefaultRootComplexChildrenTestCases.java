 ...
 */
public class AnyObjectAndAnyCollectionUC06NoDefaultRootComplexChildrenTestCases extends XMLMappingTestCases {
    public static final String XML_RESOURCE_PATH = "org/eclipse/persistence/testing/oxm/mappings/anyobjectandanycollection/Customer-data_uc06.xml";
    ...
    public AnyObjectAndAnyCollectionUC06NoDefaultRootComplexChildrenTestCases(String name) throws Exception {
        super(name);
