 ...
 */
public class BinaryDataIdentifiedByNameEmptyNSRNillableTestCases extends XMLWithJSONMappingTestCases {
    private final static String XML_RESOURCE = "org/eclipse/persistence/testing/oxm/mappings/binarydata/identifiedbyname/BinaryDataIdentifiedByNameEmptyNSRNillable.xml";
    private final static String JSON_RESOURCE = "org/eclipse/persistence/testing/oxm/mappings/binarydata/identifiedbyname/BinaryDataIdentifiedByNameEmptyNSRNillable.json";

    public BinaryDataIdentifiedByNameEmptyNSRNillableTestCases(String name) throws Exception {
        super(name);
        ...
        ((XMLBinaryDataMapping)p.getDescriptor(Employee.class).getMappingForAttributeName("data")).getNullPolicy().setNullRepresentedByXsiNil(true);
        setProject(p);
    }
