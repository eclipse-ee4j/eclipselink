 ...
 ******************************************************************************/  
package org.eclipse.persistence.testing.oxm.mappings.onetomany.keyonsource.eis.nestedgroupingelement.roottoroot;
...
public class RootToRootProject extends org.eclipse.persistence.sessions.Project {
  ...
  public RootToRootProject() {
    ...
    EISLogin login = new EISLogin(new XMLFilePlatform());
		...
		login.setProperty("directory", "./org/eclipse/persistence/testing/oxm/mappings/onetomany/keyonsource/eis/nestedgroupingelement/roottoroot/");
		setLogin(login);
  }
