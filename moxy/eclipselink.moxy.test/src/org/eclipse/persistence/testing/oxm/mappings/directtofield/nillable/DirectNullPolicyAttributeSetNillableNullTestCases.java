...
public class DirectNullPolicyAttributeSetNillableNullTestCases extends XMLWithJSONMappingTestCases {
	// TC UC 6-0
    ...
    "org/eclipse/persistence/testing/oxm/mappings/directtofield/nillable/DirectNullPolicyAttributeSetNillableNull.json";

    public DirectNullPolicyAttributeSetNillableNullTestCases(String name) throws Exception {
        super(name);
        setControlDocument(XML_RESOURCE);
        setControlJSON(JSON_RESOURCE);        AbstractNullPolicy aNullPolicy = new NullPolicy();
