...
public class CompositeObjectIdentifiedByPositionProject extends Project {

  public CompositeObjectIdentifiedByPositionProject() {
  ...
  private XMLDescriptor getEmployeeDescriptor() {
    ...
    emailMapping.setXPath("address[1]");
    ...
    addressMapping.setXPath("address[2]");
