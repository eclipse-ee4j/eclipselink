 ...
 ******************************************************************************/  
package org.eclipse.persistence.testing.oxm.mappings.compositeobject.identifiedbyposition;
...
public class CompositeObjectIdentifiedByPositionTestCases extends XMLMappingTestCases {

  private final static String XML_RESOURCE = "org/eclipse/persistence/testing/oxm/mappings/compositeobject/identifiedbyposition/CompositeObjectIdentifiedByPosition.xml";
  ...
  public CompositeObjectIdentifiedByPositionTestCases(String name) throws Exception {
    super(name);
