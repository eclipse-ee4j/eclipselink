...
public class MultipleSourceProject extends Project {
	public MultipleSourceProject() {
	...
	private XMLDescriptor getRootDescriptor() {
		...
		descriptor.setJavaClass(MultipleSourceRoot.class);
		descriptor.setDefaultRootElement("root");
		// create employee mapping
		XMLCompositeCollectionMapping empMapping = new XMLCompositeCollectionMapping();
		empMapping.setAttributeName("employees");
