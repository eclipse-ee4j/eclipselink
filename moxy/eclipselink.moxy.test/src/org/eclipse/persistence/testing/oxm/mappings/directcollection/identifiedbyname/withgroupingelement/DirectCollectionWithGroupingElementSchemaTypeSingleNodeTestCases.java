...
public class DirectCollectionWithGroupingElementSchemaTypeSingleNodeTestCases extends XMLMappingTestCases {
    private final static String XML_RESOURCE = "org/eclipse/persistence/testing/oxm/mappings/directcollection/identifiedbyname/withgroupingelement/DirectCollectionWithGroupingElementSchemaTypeSingleNode.xml";
    private final static int CONTROL_ID = 123;

    public DirectCollectionWithGroupingElementSchemaTypeSingleNodeTestCases(String name) throws Exception {
        super(name);
