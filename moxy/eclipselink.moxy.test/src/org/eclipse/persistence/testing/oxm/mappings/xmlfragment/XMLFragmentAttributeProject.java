...
/**
 *  @version $Header: XMLFragmentAttributeProject.java 02-nov-2006.10:57:28 gyorke Exp $
 *  @author  mmacivor
 *  @since   release specific (what release of product did this appear in)
 */

public class XMLFragmentAttributeProject extends Project {
    public XMLFragmentAttributeProject() {
    ...
    public void addEmployeeDescriptor() {
        ...
        mapping2.setXPath("xml-node/@attribute");
