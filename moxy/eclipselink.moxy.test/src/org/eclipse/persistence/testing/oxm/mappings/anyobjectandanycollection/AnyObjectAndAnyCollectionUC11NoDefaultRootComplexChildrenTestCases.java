...
import org.eclipse.persistence.testing.oxm.mappings.anyobjectandanycollection.colcol.Customer;
 ...
 */
public class AnyObjectAndAnyCollectionUC11NoDefaultRootComplexChildrenTestCases extends XMLMappingTestCases {
    public static final String XML_RESOURCE_PATH = "org/eclipse/persistence/testing/oxm/mappings/anyobjectandanycollection/Customer-data_uc11.xml";
    ...
    public AnyObjectAndAnyCollectionUC11NoDefaultRootComplexChildrenTestCases(String name) throws Exception {
        super(name);
