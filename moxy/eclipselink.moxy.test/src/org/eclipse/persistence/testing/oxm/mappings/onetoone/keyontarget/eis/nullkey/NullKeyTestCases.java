...
public class NullKeyTestCases extends EISMappingTestCases {

	private final static String XML_RESOURCE = "org/eclipse/persistence/testing/oxm/mappings/onetoone/keyontarget/eis/nullkey/writing/project_control.xml";
	private final static String XML_TEST_RESOURCE = "org/eclipse/persistence/testing/oxm/mappings/onetoone/keyontarget/eis/nullkey/writing/project.xml";
  ...
  public NullKeyTestCases(String name) throws Exception {
    super(name);
