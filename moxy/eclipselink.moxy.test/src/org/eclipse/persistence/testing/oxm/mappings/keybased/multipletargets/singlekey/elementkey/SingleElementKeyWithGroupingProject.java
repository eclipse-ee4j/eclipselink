...
public class SingleElementKeyWithGroupingProject extends Project {
	public SingleElementKeyWithGroupingProject() {
	...
	private XMLDescriptor getEmployeeDescriptor() {
		...
		addressMapping.addSourceToTargetKeyFieldAssociation("addresses/address-id/text()", "@aid");
