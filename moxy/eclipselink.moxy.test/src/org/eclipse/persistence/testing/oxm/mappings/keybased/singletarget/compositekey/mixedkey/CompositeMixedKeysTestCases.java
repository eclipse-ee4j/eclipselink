 ...
 ******************************************************************************/  
package org.eclipse.persistence.testing.oxm.mappings.keybased.singletarget.compositekey.mixedkey;
...
public class CompositeMixedKeysTestCases extends KeyBasedMappingTestCases {
	private final static String XML_RESOURCE = "org/eclipse/persistence/testing/oxm/mappings/keybased/singletarget/compositekey/mixedkey/instance.xml";

	public CompositeMixedKeysTestCases(String name) throws Exception {
		super(name);
