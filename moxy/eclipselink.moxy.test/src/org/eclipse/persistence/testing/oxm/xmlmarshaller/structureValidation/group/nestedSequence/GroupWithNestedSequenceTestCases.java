...
import org.eclipse.persistence.testing.oxm.xmlmarshaller.structureValidation.group.nestedSequence.EmploymentInfo.Period;

public class GroupWithNestedSequenceTestCases extends OXTestCase {
    ...
    public GroupWithNestedSequenceTestCases(String name) throws Exception {
        super(name);
    }
    ...
    public void testValidEmployee() throws Exception {
        ...
        info.setStartDateAndEndDate(period);
