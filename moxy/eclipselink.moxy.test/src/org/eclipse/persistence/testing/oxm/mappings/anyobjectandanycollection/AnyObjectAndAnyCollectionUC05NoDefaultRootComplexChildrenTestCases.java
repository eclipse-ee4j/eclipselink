 ...
 */
public class AnyObjectAndAnyCollectionUC05NoDefaultRootComplexChildrenTestCases extends XMLMappingTestCases {
    public static final String XML_RESOURCE_PATH = "org/eclipse/persistence/testing/oxm/mappings/anyobjectandanycollection/Customer-data_uc05.xml";
    ...
    public AnyObjectAndAnyCollectionUC05NoDefaultRootComplexChildrenTestCases(String name) throws Exception {
        super(name);
