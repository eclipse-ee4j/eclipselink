...
wget -nc https://repo1.maven.org/maven2/org/hibernate/validator/hibernate-validator/6.0.20.Final/hibernate-validator-6.0.20.Final.jar -O $HOME/extension.lib.external/hibernate-validator-6.0.20.Final.jar
