...
wget -nc https://repo1.maven.org/maven2/com/mysql/mysql-connector-j/8.2.0/mysql-connector-j-8.2.0.jar -O $HOME/extension.lib.external/mysql-connector-j-8.2.0.jar
...
echo "jdbc.driver.jar=$HOME/extension.lib.external/mysql-connector-j-8.2.0.jar" >> $HOME/build.properties
