...
public class LoggingLocalizationResource extends ListResourceBundle {
    ...
    static final Object[][] contents = {
            ...
            { "jpars_could_bootstrap_persistence_context", "requestId: {0}. Persistence Context: [{1}] could not be bootstrapped." },
            ...
            { "jpars_could_not_entity_for_key", "requestId: {0}. Entity of type [{1}] and id [{2}] could not be found in persistence unit: [{3}]." },
            { "jpars_could_not_entity_for_attribute", "requestId: {0}. Attribute [{1}] for entity of type [{2}] and id [{3}] could not be found in persistence unit: [{4}]." },
            { "jpars_could_find_appropriate_mapping_for_update", "requestId: {0}. Attribute [{1}] for entity of type [{2}] in persistence unit: [{3}] is not the appropriate type for an update or delete." },
            ...
            { "jpars_could_marshal_requested_result_to_requested_type", "requestId: {0}. JPA RS could not marshall object [{1}] to the requested type." },
